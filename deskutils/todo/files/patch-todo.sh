% sed -i .orig 's|/etc/todo/config|%%PREFIX%%&|' todo.sh

--- todo.sh.orig	2026-09-01 17:18:36 UTC
+++ todo.sh
@@ -666,7 +666,7 @@ TODOTXT_FINAL_FILTER=${TODOTXT_FINAL_FILTER:-cat}
...
+TODOTXT_GLOBAL_CFG_FILE=${TODOTXT_GLOBAL_CFG_FILE:-%%PREFIX%%/etc/todo/config}
