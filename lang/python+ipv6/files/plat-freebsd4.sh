...
#	plat-freebsd4
#	plat-freebsd4/regen
#	plat-freebsd4/FCNTL.py
#	plat-freebsd4/SOCKET.py
#	plat-freebsd4/IN.py
#	plat-freebsd4/TERMIOS.py
#
echo c - plat-freebsd4
mkdir -p plat-freebsd4 > /dev/null 2>&1
echo x - plat-freebsd4/regen
sed 's/^X//' >plat-freebsd4/regen << 'END-of-plat-freebsd4/regen'
X#! /bin/sh
Xset -v
...
END-of-plat-freebsd4/regen
echo x - plat-freebsd4/FCNTL.py
sed 's/^X//' >plat-freebsd4/FCNTL.py << 'END-of-plat-freebsd4/FCNTL.py'
...
XLOCK_NB = 0x04
XLOCK_UN = 0x08
END-of-plat-freebsd4/FCNTL.py
echo x - plat-freebsd4/SOCKET.py
sed 's/^X//' >plat-freebsd4/SOCKET.py << 'END-of-plat-freebsd4/SOCKET.py'
...
Xdef __COPYRIGHT(s): return __IDSTRING(copyright,s)
X
END-of-plat-freebsd4/SOCKET.py
echo x - plat-freebsd4/IN.py
sed 's/^X//' >plat-freebsd4/IN.py << 'END-of-plat-freebsd4/IN.py'
...
XIPCTL_MAXID = 15
END-of-plat-freebsd4/IN.py
echo x - plat-freebsd4/TERMIOS.py
sed 's/^X//' >plat-freebsd4/TERMIOS.py << 'END-of-plat-freebsd4/TERMIOS.py'
...
XCRPRNT = CREPRINT
XCFLUSH = CDISCARD
END-of-plat-freebsd4/TERMIOS.py
exit
