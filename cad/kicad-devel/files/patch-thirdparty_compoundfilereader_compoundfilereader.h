--- thirdparty/compoundfilereader/compoundfilereader.h.orig	2026-08-21 21:35:49 UTC
...
@@ -398,7 +398,7 @@ class CompoundFileReader (private)
...
@@ -629,4 +629,4 @@ class PropertySetStream (private)
