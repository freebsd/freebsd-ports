--- helix-loader/src/grammar.rs.orig	2023-10-25 16:37:27 UTC
+++ helix-loader/src/grammar.rs
@@ -86,10 +86,7 @@ pub fn get_language(name: &str) -> Result<Language> {
 }
...
@@ -98,57 +95,6 @@ pub fn fetch_grammars() -> Result<()> {
