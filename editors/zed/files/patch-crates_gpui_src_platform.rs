--- crates/gpui/src/platform.rs.orig	2026-08-05 15:24:27 UTC
...
@@ -888,7 +888,7 @@ pub trait PlatformWindow: HasWindowHandle + HasDisplay
...
@@ -2007,7 +2007,7 @@ pub enum WindowKind {
