--- crates/gpui/src/platform.rs.orig	2026-08-19 14:43:57 UTC
...
@@ -897,7 +897,7 @@ pub trait PlatformWindow: HasWindowHandle + HasDisplay
     }
...
@@ -2021,7 +2021,7 @@ pub enum WindowKind {
