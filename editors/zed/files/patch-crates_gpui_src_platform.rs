--- crates/gpui/src/platform.rs.orig	2026-08-12 14:40:25 UTC
...
@@ -894,7 +894,7 @@ pub trait PlatformWindow: HasWindowHandle + HasDisplay
     }
...
@@ -2018,7 +2018,7 @@ pub enum WindowKind {
