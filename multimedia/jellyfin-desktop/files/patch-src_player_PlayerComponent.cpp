--- src/player/PlayerComponent.cpp.orig	2025-12-14 11:13:03 UTC
+++ src/player/PlayerComponent.cpp
@@ -313,39 +313,39 @@ void PlayerComponent::queueMedia(const QString& url, c
   QUrl qurl = url;
...
@@ -851,7 +851,7 @@ void PlayerComponent::seekTo(qint64 ms)
     return;
   }
