--- src/webrtc/src/third_party/perfetto/src/base/android_utils.cc.orig	2026-03-13 06:02:14 UTC
+++ src/webrtc/src/third_party/perfetto/src/base/android_utils.cc
@@ -36,8 +36,10 @@
 #include <unistd.h>
 #endif
