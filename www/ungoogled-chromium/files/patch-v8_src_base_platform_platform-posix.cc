--- v8/src/base/platform/platform-posix.cc.orig	2023-06-05 19:39:05 UTC
...
@@ -664,7 +672,7 @@ void OS::DestroySharedMemoryHandle(PlatformSharedMemor
...
@@ -1241,7 +1249,7 @@ void Thread::SetThreadLocal(LocalStorageKey key, void*
