--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2024-08-26 14:40:28 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -379,7 +379,7 @@ bool IsAboutUI(const GURL& url) {
...
@@ -570,7 +570,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -626,7 +626,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
@@ -676,26 +676,26 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
   }
 #endif
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || \
-    BUILDFLAG(IS_ANDROID)
