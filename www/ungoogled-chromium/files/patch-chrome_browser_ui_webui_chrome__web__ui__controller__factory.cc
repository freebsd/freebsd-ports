--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2023-10-13 13:20:35 UTC
...
@@ -400,7 +400,7 @@ bool IsAboutUI(const GURL& url) {
...
@@ -790,27 +790,27 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
   }
 #endif
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || \
-    BUILDFLAG(IS_ANDROID)
