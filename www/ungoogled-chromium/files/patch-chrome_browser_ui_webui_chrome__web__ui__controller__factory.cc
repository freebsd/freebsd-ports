--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2024-10-27 06:40:35 UTC
...
@@ -504,7 +504,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -556,7 +556,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
@@ -597,26 +597,26 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
   }
 #endif
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || \
-    BUILDFLAG(IS_ANDROID)
