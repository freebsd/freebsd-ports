--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2024-03-22 14:16:19 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -680,7 +680,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
@@ -735,27 +735,27 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
   }
 #endif
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || \
-    BUILDFLAG(IS_ANDROID)
