--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2023-08-18 10:26:52 UTC
...
@@ -665,7 +665,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -727,7 +727,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
