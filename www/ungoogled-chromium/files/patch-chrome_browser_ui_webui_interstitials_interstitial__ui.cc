--- chrome/browser/ui/webui/interstitials/interstitial_ui.cc.orig	2024-10-27 06:40:35 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -291,7 +291,7 @@ std::unique_ptr<EnterpriseBlockPage> CreateEnterpriseB
                                                         kRequestUrl));
 }
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 CreateSupervisedUserVerificationPage(content::WebContents* web_contents,
                                      bool is_main_frame) {
@@ -448,7 +448,7 @@ void InterstitialHTMLSource::StartDataRequest(
