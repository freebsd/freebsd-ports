--- chrome/browser/extensions/api/enterprise_reporting_private/enterprise_reporting_private_api.cc.orig	2022-12-02 17:56:32 UTC
...
@@ -590,7 +590,7 @@ void EnterpriseReportingPrivateEnqueueRecordFunction::
 }
 #endif
