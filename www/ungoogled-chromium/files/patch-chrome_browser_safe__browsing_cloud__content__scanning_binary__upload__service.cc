--- chrome/browser/safe_browsing/cloud_content_scanning/binary_upload_service.cc.orig	2025-01-25 09:34:31 UTC
...
@@ -437,7 +437,7 @@ BinaryUploadService* BinaryUploadService::GetForProfil
     Profile* profile,
