--- chrome/browser/safe_browsing/cloud_content_scanning/binary_upload_service.cc.orig	2025-02-20 09:59:21 UTC
...
@@ -451,7 +451,7 @@ BinaryUploadService* BinaryUploadService::GetForProfil
     Profile* profile,
