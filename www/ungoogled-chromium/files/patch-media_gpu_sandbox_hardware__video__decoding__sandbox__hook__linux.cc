--- media/gpu/sandbox/hardware_video_decoding_sandbox_hook_linux.cc.orig	2026-08-13 07:41:05 UTC
...
+#if !BUILDFLAG(IS_BSD)
 void AllowAccessToRenderNodes(std::vector<BrokerFilePermission>& permissions,
                               ...
                               bool read_write) {
@@ -207,6 +210,7 @@ bool HardwareVideoDecodingPreSandboxHookForV4L2(
   NOTREACHED();
...
@@ -222,6 +226,7 @@ bool HardwareVideoDecodingPreSandboxHookForV4L2(
 //   (at least).
