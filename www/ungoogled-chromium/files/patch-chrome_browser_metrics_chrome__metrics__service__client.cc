--- chrome/browser/metrics/chrome_metrics_service_client.cc.orig	2022-12-02 17:56:32 UTC
...
@@ -1090,7 +1090,7 @@ bool ChromeMetricsServiceClient::RegisterForProfileEve
 #endif
 // TODO(crbug.com/1052397): Revisit the macro expression once build flag switch
 // of lacros-chrome is complete.
-#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || \
