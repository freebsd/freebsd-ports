--- chrome/browser/ui/webui/user_education_internals/user_education_internals_page_handler_impl.cc.orig	2026-08-13 07:41:05 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
   return nullptr;
@@ -934,7 +934,7 @@ void UserEducationInternalsPageHandlerImpl::ClearWhats
 }
