--- third_party/blink/renderer/modules/webgpu/gpu_canvas_context.cc.orig	2026-02-15 10:01:45 UTC
+++ third_party/blink/renderer/modules/webgpu/gpu_canvas_context.cc
@@ -268,7 +268,7 @@ GPUCanvasContext::PaintRenderingResultsToCanvas(
