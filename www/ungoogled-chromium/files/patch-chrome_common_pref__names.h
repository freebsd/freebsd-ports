--- chrome/common/pref_names.h.orig	2025-01-25 09:34:31 UTC
+++ chrome/common/pref_names.h
@@ -1353,7 +1353,7 @@ inline constexpr char kUseAshProxy[] = "lacros.proxy.u
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2599,14 +2599,14 @@ inline constexpr char kMediaStorageIdSalt[] = "media.s
...
+    BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -3818,7 +3818,7 @@ inline constexpr char kScreenCaptureWithoutGestureAllo
...
@@ -4179,7 +4179,7 @@ inline constexpr char kPrintingOAuth2AuthorizationServ
