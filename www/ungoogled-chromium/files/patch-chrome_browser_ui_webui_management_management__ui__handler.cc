--- chrome/browser/ui/webui/management/management_ui_handler.cc.orig	2023-08-18 10:26:52 UTC
...
@@ -177,12 +177,12 @@ enum class ReportingType {
   kUserActivity
 };
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
@@ -737,7 +737,7 @@ void ManagementUIHandler::AddReportingInfo(base::Value
...
@@ -1008,7 +1008,7 @@ base::Value::Dict ManagementUIHandler::GetThreatProtec
                                   &info);
   }
...
@@ -1053,7 +1053,7 @@ policy::PolicyService* ManagementUIHandler::GetPolicyS
       ->policy_service();
 }
