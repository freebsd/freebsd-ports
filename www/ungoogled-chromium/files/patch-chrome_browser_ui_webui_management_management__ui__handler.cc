--- chrome/browser/ui/webui/management/management_ui_handler.cc.orig	2024-10-27 06:40:35 UTC
...
@@ -547,7 +547,7 @@ policy::PolicyService* ManagementUIHandler::GetPolicyS
       ->policy_service();
 }
