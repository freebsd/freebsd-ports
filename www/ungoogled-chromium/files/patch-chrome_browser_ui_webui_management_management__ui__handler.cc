--- chrome/browser/ui/webui/management/management_ui_handler.cc.orig	2023-09-17 07:59:53 UTC
...
@@ -182,12 +182,12 @@ enum class ReportingType {
   kUserActivity
 };
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
@@ -746,7 +746,7 @@ void ManagementUIHandler::AddReportingInfo(base::Value
...
@@ -1024,7 +1024,7 @@ base::Value::Dict ManagementUIHandler::GetThreatProtec
                                   &info);
   }
...
@@ -1108,7 +1108,7 @@ policy::PolicyService* ManagementUIHandler::GetPolicyS
       ->policy_service();
 }
