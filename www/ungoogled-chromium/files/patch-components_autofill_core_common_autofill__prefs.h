--- components/autofill/core/common/autofill_prefs.h.orig	2026-02-15 10:01:45 UTC
+++ components/autofill/core/common/autofill_prefs.h
@@ -66,7 +66,7 @@ inline constexpr char kAutofillAiLastVersionDeduped[] 
...
@@ -309,7 +309,7 @@ bool IsFacilitatedPaymentsA2AEnabled(const PrefService
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 void SetAutofillBnplEnabled(PrefService* prefs, bool value);
         ...
         // BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID)
@@ -317,7 +317,7 @@ void SetAutofillBnplEnabled(PrefService* prefs, bool v
