--- chrome/browser/policy/configuration_policy_handler_list_factory.cc.orig	2025-02-20 09:59:21 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
@@ -563,7 +563,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
@@ -910,13 +910,13 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kNetworkServiceSandboxEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -1841,12 +1841,12 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kUnmanagedDeviceSignalsConsentFlowEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -1854,7 +1854,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kDefaultBrowserSettingEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -1866,7 +1866,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
     base::Value::Type::BOOLEAN },
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) \
-    || BUILDFLAG(IS_CHROMEOS)
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
   { key::kAlternativeBrowserPath,
     ...
     base::Value::Type::STRING },
@@ -2069,7 +2069,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   { key::kAuthNegotiateDelegateByKdcPolicy,
     ...
     base::Value::Type::BOOLEAN },
@@ -2143,7 +2143,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
+#if BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kOutOfProcessSystemDnsResolutionEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -2209,7 +2209,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
     base::Value::Type::INTEGER },
 #endif
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
   { key::kChromeForTestingAllowed,
     ...
     base::Value::Type::BOOLEAN },
@@ -2389,7 +2389,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -2405,7 +2405,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
         // BUILDFLAG(IS_CHROMEOS_ASH)
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   handlers->AddHandler(
@@ -2598,7 +2598,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
+    BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
   ...
   handlers->AddHandler(
@@ -2651,7 +2651,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -3086,7 +3086,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
