--- content/browser/renderer_host/render_process_host_impl.cc.orig	2023-01-13 08:56:02 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
     if (auto font_receiver = receiver.As<font_service::mojom::FontService>()) {
       ...
       return;
@@ -2130,7 +2130,7 @@ void RenderProcessHostImpl::ReinitializeLogging(
 }
...
@@ -4761,7 +4762,7 @@ void RenderProcessHostImpl::ResetIPC() {
