--- content/browser/renderer_host/render_process_host_impl.cc.orig	2024-10-27 06:40:35 UTC
...
@@ -1264,7 +1264,7 @@ RenderProcessHostImpl::IOThreadHostImpl::~IOThreadHost
...
@@ -3343,6 +3343,7 @@ void RenderProcessHostImpl::PropagateBrowserCommandLin
