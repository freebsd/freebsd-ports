--- content/browser/renderer_host/render_process_host_impl.cc.orig	2022-12-02 17:56:32 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
     if (auto font_receiver = receiver.As<font_service::mojom::FontService>()) {
       ...
       return;
@@ -2120,7 +2120,7 @@ void RenderProcessHostImpl::ReinitializeLogging(
 }
...
@@ -4746,7 +4747,7 @@ void RenderProcessHostImpl::ResetIPC() {
