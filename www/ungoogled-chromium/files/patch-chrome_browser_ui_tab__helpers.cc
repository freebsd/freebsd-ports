--- chrome/browser/ui/tab_helpers.cc.orig	2022-12-02 17:56:32 UTC
...
@@ -535,13 +535,13 @@ void TabHelpers::AttachTabHelpers(WebContents* web_con
...
@@ -564,7 +564,7 @@ void TabHelpers::AttachTabHelpers(WebContents* web_con
 #endif
