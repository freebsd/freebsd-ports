--- chrome/browser/ui/tab_helpers.cc.orig	2023-01-13 08:56:02 UTC
...
@@ -531,13 +531,13 @@ void TabHelpers::AttachTabHelpers(WebContents* web_con
...
@@ -560,7 +560,7 @@ void TabHelpers::AttachTabHelpers(WebContents* web_con
 #endif
