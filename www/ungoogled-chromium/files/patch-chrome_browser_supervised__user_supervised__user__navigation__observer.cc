--- chrome/browser/supervised_user/supervised_user_navigation_observer.cc.orig	2026-03-15 18:32:51 UTC
...
@@ -75,7 +75,7 @@ std::unique_ptr<supervised_user::WebContentHandler> Cr
