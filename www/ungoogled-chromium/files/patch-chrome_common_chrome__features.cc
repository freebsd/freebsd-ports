--- chrome/common/chrome_features.cc.orig	2024-02-25 20:22:18 UTC
...
@@ -385,7 +385,7 @@ const base::FeatureParam<bool> kDnsOverHttpsFallbackPa
...
+    BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
       false
@@ -952,7 +952,7 @@ BASE_FEATURE(kLacrosSharedComponentsDir,
              base::FEATURE_ENABLED_BY_DEFAULT);
...
+#if (BUILDFLAG(IS_LINUX) && !BUILDFLAG(IS_CHROMEOS)) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kLinuxLowMemoryMonitor,
              ...
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -965,7 +965,7 @@ constexpr base::FeatureParam<int> kLinuxLowMemoryMonit
