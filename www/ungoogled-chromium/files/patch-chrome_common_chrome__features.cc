--- chrome/common/chrome_features.cc.orig	2022-12-02 17:56:32 UTC
...
+    BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
       false
@@ -739,7 +739,7 @@ BASE_FEATURE(kUpdateHistoryEntryPointsInIncognito,
...
+#if (BUILDFLAG(IS_LINUX) && !BUILDFLAG(IS_CHROMEOS)) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kLinuxLowMemoryMonitor,
              ...
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -752,7 +752,7 @@ constexpr base::FeatureParam<int> kLinuxLowMemoryMonit
