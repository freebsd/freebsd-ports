--- content/app/content_main_runner_impl.cc.orig	2024-02-25 20:22:18 UTC
...
@@ -1031,8 +1044,20 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1135,6 +1160,11 @@ int NO_STACK_PROTECTOR ContentMainRunnerImpl::Run() {
