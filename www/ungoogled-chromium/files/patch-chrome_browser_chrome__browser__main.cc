--- chrome/browser/chrome_browser_main.cc.orig	2024-07-31 14:19:23 UTC
...
@@ -1150,7 +1150,7 @@ int ChromeBrowserMainParts::PreCreateThreadsImpl() {
 // TODO(crbug.com/40118868): Revisit the macro expression once build flag switch
 // of lacros-chrome is complete.
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS_LACROS)
...
@@ -1496,7 +1496,7 @@ int ChromeBrowserMainParts::PreMainMessageLoopRunImpl(
...
@@ -2042,7 +2042,7 @@ bool ChromeBrowserMainParts::ProcessSingletonNotificat
