--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2023-10-13 13:20:35 UTC
...
@@ -293,7 +293,7 @@ void AddA11yStrings(content::WebUIDataSource* html_sou
     {"focusHighlightLabel",
