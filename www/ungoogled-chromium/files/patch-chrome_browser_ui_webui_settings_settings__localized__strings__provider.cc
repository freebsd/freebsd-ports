--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2022-12-02 17:56:32 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -226,7 +226,7 @@ void AddCommonStrings(content::WebUIDataSource* html_s
 #endif
...
+#if (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)) && !BUILDFLAG(IS_CHROMEOS_LACROS)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -406,7 +406,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
