--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2023-07-21 09:49:17 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -242,7 +242,7 @@ void AddCommonStrings(content::WebUIDataSource* html_s
