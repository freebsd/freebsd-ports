--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2025-12-06 13:30:52 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -276,7 +276,7 @@ void AddA11yStrings(content::WebUIDataSource* html_sou
...
@@ -1717,7 +1717,7 @@ void AddSignOutDialogStrings(content::WebUIDataSource*
