...
@@ -554,7 +554,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -562,11 +562,11 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -591,7 +591,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
