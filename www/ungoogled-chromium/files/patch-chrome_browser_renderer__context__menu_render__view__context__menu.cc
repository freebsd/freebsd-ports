--- chrome/browser/renderer_context_menu/render_view_context_menu.cc.orig	2026-03-15 18:32:51 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -5112,7 +5112,7 @@ void RenderViewContextMenu::OpenLinkInSplitView() {
