--- chrome/browser/renderer_context_menu/render_view_context_menu.cc.orig	2026-02-15 10:01:45 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -5119,7 +5119,7 @@ void RenderViewContextMenu::OpenLinkInSplitView() {
