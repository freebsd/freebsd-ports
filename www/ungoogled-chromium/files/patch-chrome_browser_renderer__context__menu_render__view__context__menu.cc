--- chrome/browser/renderer_context_menu/render_view_context_menu.cc.orig	2026-06-05 13:45:06 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -5160,7 +5160,7 @@ void RenderViewContextMenu::OpenLinkInSplitView() {
