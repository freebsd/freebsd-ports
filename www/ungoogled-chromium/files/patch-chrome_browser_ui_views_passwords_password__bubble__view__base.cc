--- chrome/browser/ui/views/passwords/password_bubble_view_base.cc.orig	2026-01-16 13:40:34 UTC
...
@@ -159,7 +159,7 @@ PasswordBubbleViewBase* PasswordBubbleViewBase::Create
   } else if (model_state ==
