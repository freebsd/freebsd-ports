--- chrome/browser/ui/views/passwords/password_bubble_view_base.cc.orig	2026-08-13 07:41:05 UTC
...
@@ -165,7 +165,7 @@ PasswordBubbleViewBase* PasswordBubbleViewBase::Create
   } else if (model_state ==
