--- chrome/browser/ui/views/passwords/password_bubble_view_base.cc.orig	2024-07-31 14:19:23 UTC
...
@@ -133,7 +133,7 @@ PasswordBubbleViewBase* PasswordBubbleViewBase::Create
   } else if (model_state ==
