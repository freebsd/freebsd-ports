--- chrome/browser/ui/views/passwords/password_bubble_view_base.cc.orig	2026-06-05 13:45:06 UTC
...
@@ -161,7 +161,7 @@ PasswordBubbleViewBase* PasswordBubbleViewBase::Create
   } else if (model_state ==
