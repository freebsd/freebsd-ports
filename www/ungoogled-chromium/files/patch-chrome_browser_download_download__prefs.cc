--- chrome/browser/download/download_prefs.cc.orig	2024-10-27 06:40:35 UTC
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -293,7 +298,7 @@ void DownloadPrefs::RegisterProfilePrefs(
...
@@ -456,7 +461,7 @@ void DownloadPrefs::DisableAutoOpenByUserBasedOnExtens
 }
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 void DownloadPrefs::SetShouldOpenPdfInSystemReader(bool should_open) {
   if (should_open_pdf_in_system_reader_ == should_open)
     return;
@@ -482,7 +487,7 @@ bool DownloadPrefs::ShouldOpenPdfInSystemReader() cons
...
@@ -519,7 +524,7 @@ void DownloadPrefs::SaveAutoOpenState() {
