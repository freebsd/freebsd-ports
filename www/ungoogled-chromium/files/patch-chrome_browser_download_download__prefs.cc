--- chrome/browser/download/download_prefs.cc.orig	2025-01-25 09:34:31 UTC
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -294,7 +299,7 @@ void DownloadPrefs::RegisterProfilePrefs(
...
@@ -457,7 +462,7 @@ void DownloadPrefs::DisableAutoOpenByUserBasedOnExtens
 }
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 void DownloadPrefs::SetShouldOpenPdfInSystemReader(bool should_open) {
   if (should_open_pdf_in_system_reader_ == should_open)
     return;
@@ -483,7 +488,7 @@ bool DownloadPrefs::ShouldOpenPdfInSystemReader() cons
...
@@ -520,7 +525,7 @@ void DownloadPrefs::SaveAutoOpenState() {
