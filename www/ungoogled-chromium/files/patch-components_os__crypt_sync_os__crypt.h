--- components/os_crypt/sync/os_crypt.h.orig	2025-12-06 13:30:52 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_LINUX)
@@ -91,7 +91,7 @@ COMPONENT_EXPORT(OS_CRYPT) void UseMockKeyForTesting(b
...
@@ -125,7 +125,7 @@ class COMPONENT_EXPORT(OS_CRYPT) OSCryptImpl {
...
@@ -244,13 +244,13 @@ class COMPONENT_EXPORT(OS_CRYPT) OSCryptImpl {
   bool DeriveKey();
