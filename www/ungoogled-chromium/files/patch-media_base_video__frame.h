--- media/base/video_frame.h.orig	2025-04-15 08:30:07 UTC
...
@@ -737,7 +737,7 @@ class MEDIA_EXPORT VideoFrame : public base::RefCounte
...
@@ -977,7 +977,7 @@ class MEDIA_EXPORT VideoFrame : public base::RefCounte
