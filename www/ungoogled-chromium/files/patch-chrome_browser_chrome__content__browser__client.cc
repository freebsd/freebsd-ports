--- chrome/browser/chrome_content_browser_client.cc.orig	2026-03-15 18:32:51 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -1440,7 +1440,7 @@ void ChromeContentBrowserClient::RegisterLocalStatePre
...
@@ -1705,7 +1705,7 @@ ChromeContentBrowserClient::GetStoragePartitionConfigF
...
@@ -2582,7 +2582,7 @@ bool ChromeContentBrowserClient::ShouldUrlUseApplicati
     const GURL& url) {
 #if BUILDFLAG(ENABLE_EXTENSIONS)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS)
...
@@ -3053,7 +3055,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
     }
   }
...
@@ -4103,7 +4105,7 @@ GetPreferredColorScheme(const WebPreferences& web_pref
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -5037,7 +5039,7 @@ void ChromeContentBrowserClient::GetAdditionalAllowedS
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
         // BUILDFLAG(IS_CHROMEOS)
@@ -5091,7 +5093,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
...
+#if BUILDFLAG(IS_POSIX) && !BUILDFLAG(IS_MAC) && !BUILDFLAG(IS_BSD)
 void ChromeContentBrowserClient::GetAdditionalMappedFilesForChildProcess(
     ...
     int child_process_id,
@@ -5989,7 +5991,7 @@ ChromeContentBrowserClient::CreateNonNetworkNavigation
   }
 #endif  // BUILDFLAG(IS_CHROMEOS)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS)
...
@@ -6015,7 +6017,7 @@ void ChromeContentBrowserClient::
   DCHECK(factories);
...
@@ -6044,7 +6046,7 @@ void ChromeContentBrowserClient::
   DCHECK(factories);
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   if (content::AreIsolatedWebAppsEnabled(browser_context) &&
       !browser_context->ShutdownStarted()) {
     factories->emplace(webapps::kIsolatedAppScheme,
@@ -6319,7 +6321,7 @@ void ChromeContentBrowserClient::
 #endif  // BUILDFLAG(IS_CHROMEOS)
...
@@ -6922,7 +6924,7 @@ bool ChromeContentBrowserClient::HandleExternalProtoco
...
@@ -7051,7 +7053,7 @@ bool ChromeContentBrowserClient::HandleWebUI(
   }
...
@@ -7330,7 +7332,7 @@ bool ChromeContentBrowserClient::ShouldSandboxNetworkS
...
@@ -7763,7 +7765,7 @@ void ChromeContentBrowserClient::
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   // default.
@@ -8201,7 +8203,7 @@ ChromeContentBrowserClient::GetAlternativeErrorPageOve
