--- chrome/browser/chrome_content_browser_client.cc.orig	2023-07-21 09:49:17 UTC
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS) || BUILDFLAG(IS_BSD)
   main_parts = std::make_unique<ChromeBrowserMainPartsLinux>(
       is_integration_test, &startup_data_);
 #elif BUILDFLAG(IS_ANDROID)
@@ -1711,7 +1711,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
@@ -1751,7 +1751,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
@@ -2575,6 +2575,8 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
 #if(0)
...
@@ -2972,7 +2974,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4444,7 +4446,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   MaybeAddThrottle(browser_switcher::BrowserSwitcherNavigationThrottle::
                        MaybeCreateThrottleFor(handle),
                    &throttles);
@@ -6692,7 +6694,7 @@ bool ChromeContentBrowserClient::ShouldSandboxNetworkS
 }
