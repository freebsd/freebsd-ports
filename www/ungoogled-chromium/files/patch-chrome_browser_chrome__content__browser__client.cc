--- chrome/browser/chrome_content_browser_client.cc.orig	2026-05-09 18:09:27 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -1532,7 +1532,7 @@ void ChromeContentBrowserClient::RegisterLocalStatePre
...
@@ -2674,7 +2674,7 @@ bool ChromeContentBrowserClient::ShouldUrlUseApplicati
     const GURL& url) {
 #if BUILDFLAG(ENABLE_EXTENSIONS)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS)
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!content::AreIsolatedWebAppsEnabled(browser_context)) {
     return false;
@@ -2802,7 +2802,9 @@ void MaybeAppendBlinkSettingsSwitchForFieldTrial(
...
@@ -2811,7 +2813,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -3149,7 +3151,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
     }
   }
...
@@ -4161,7 +4163,7 @@ GetPreferredColorScheme(const WebPreferences& web_pref
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -5159,7 +5161,7 @@ void ChromeContentBrowserClient::GetAdditionalAllowedS
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
         // BUILDFLAG(IS_CHROMEOS)
@@ -5213,7 +5215,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
...
+#if BUILDFLAG(IS_POSIX) && !BUILDFLAG(IS_MAC) && !BUILDFLAG(IS_BSD)
 void ChromeContentBrowserClient::GetAdditionalMappedFilesForChildProcess(
     ...
     int child_process_id,
@@ -6111,7 +6113,7 @@ ChromeContentBrowserClient::CreateNonNetworkNavigation
   }
 #endif  // BUILDFLAG(IS_CHROMEOS)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS)
...
@@ -6137,7 +6139,7 @@ void ChromeContentBrowserClient::
   DCHECK(factories);
...
@@ -6166,7 +6168,7 @@ void ChromeContentBrowserClient::
   DCHECK(factories);
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   if (content::AreIsolatedWebAppsEnabled(browser_context) &&
       !browser_context->ShutdownStarted()) {
     factories->emplace(webapps::kIsolatedAppScheme,
@@ -6439,7 +6441,7 @@ void ChromeContentBrowserClient::
 #endif  // BUILDFLAG(IS_CHROMEOS)
...
@@ -7045,7 +7047,7 @@ bool ChromeContentBrowserClient::HandleExternalProtoco
...
@@ -7174,7 +7176,7 @@ bool ChromeContentBrowserClient::HandleWebUI(
   }
...
@@ -7889,7 +7891,7 @@ void ChromeContentBrowserClient::
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   // default.
@@ -8335,7 +8337,7 @@ ChromeContentBrowserClient::GetAlternativeErrorPageOve
