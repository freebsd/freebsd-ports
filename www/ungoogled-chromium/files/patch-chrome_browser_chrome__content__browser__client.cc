--- chrome/browser/chrome_content_browser_client.cc.orig	2024-08-26 14:40:28 UTC
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS) || BUILDFLAG(IS_BSD)
   main_parts = std::make_unique<ChromeBrowserMainPartsLinux>(
       is_integration_test, &startup_data_);
 #elif BUILDFLAG(IS_ANDROID)
@@ -1809,7 +1809,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS) || BUILDFLAG(IS_BSD)
 ...
 #else
@@ -1830,7 +1830,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
@@ -1849,7 +1849,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
@@ -3045,7 +3045,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
     }
   }
...
@@ -4873,7 +4873,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   MaybeAddThrottle(browser_switcher::BrowserSwitcherNavigationThrottle::
                        MaybeCreateThrottleFor(handle),
                    &throttles);
@@ -7364,7 +7364,7 @@ bool ChromeContentBrowserClient::ShouldSandboxNetworkS
