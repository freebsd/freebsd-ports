--- chrome/browser/chrome_content_browser_client.cc.orig	2023-02-11 09:11:04 UTC
...
@@ -1624,7 +1624,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS) || BUILDFLAG(IS_BSD)
   main_parts = std::make_unique<ChromeBrowserMainPartsLinux>(
       is_integration_test, &startup_data_);
 #elif BUILDFLAG(IS_ANDROID)
@@ -1663,7 +1663,7 @@ ChromeContentBrowserClient::CreateBrowserMainParts(boo
...
@@ -2526,6 +2526,8 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
 #if(0)
...
@@ -2909,7 +2911,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4392,7 +4394,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
