--- chrome/browser/chrome_content_browser_client.cc.orig	2023-10-13 13:20:35 UTC
...
@@ -2605,6 +2605,8 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
 #if(0)
...
@@ -2982,7 +2984,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4590,7 +4592,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   MaybeAddThrottle(browser_switcher::BrowserSwitcherNavigationThrottle::
                        MaybeCreateThrottleFor(handle),
                    &throttles);
@@ -6991,7 +6993,7 @@ bool ChromeContentBrowserClient::ShouldSandboxNetworkS
 }
