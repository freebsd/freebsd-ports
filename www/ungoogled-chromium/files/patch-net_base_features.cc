--- net/base/features.cc.orig	2026-03-15 18:32:51 UTC
...
@@ -299,7 +299,7 @@ inline constexpr auto kMigrateSessionsOnNetworkChangeV
...
@@ -411,7 +411,7 @@ BASE_FEATURE(kReportingApiEnableEnterpriseCookieIssues
              base::FEATURE_DISABLED_BY_DEFAULT);
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -519,7 +519,7 @@ BASE_FEATURE(kHttpCacheMappedFileFlushWin, base::FEATU
