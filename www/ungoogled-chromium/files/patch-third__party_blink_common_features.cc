--- third_party/blink/common/features.cc.orig	2025-12-06 13:30:52 UTC
+++ third_party/blink/common/features.cc
@@ -597,7 +597,7 @@ BASE_FEATURE_PARAM(base::TimeDelta,
...
@@ -1955,7 +1955,7 @@ BASE_FEATURE(kPrefetchFontLookupTables,
