--- chrome/browser/profiles/chrome_browser_main_extra_parts_profiles.cc.orig	2025-02-20 09:59:21 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -841,21 +841,21 @@ void ChromeBrowserMainExtraPartsProfiles::
