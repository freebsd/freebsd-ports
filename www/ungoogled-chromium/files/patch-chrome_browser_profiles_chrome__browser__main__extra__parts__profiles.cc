--- chrome/browser/profiles/chrome_browser_main_extra_parts_profiles.cc.orig	2025-12-06 13:30:52 UTC
...
@@ -674,7 +674,7 @@ void ChromeBrowserMainExtraPartsProfiles::
...
@@ -773,7 +773,7 @@ void ChromeBrowserMainExtraPartsProfiles::
...
@@ -903,11 +903,11 @@ void ChromeBrowserMainExtraPartsProfiles::
 #endif
...
+    BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -926,10 +926,10 @@ void ChromeBrowserMainExtraPartsProfiles::
 #endif
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -1251,7 +1251,7 @@ void ChromeBrowserMainExtraPartsProfiles::
