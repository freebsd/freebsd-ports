--- chrome/browser/profiles/chrome_browser_main_extra_parts_profiles.cc.orig	2026-01-16 13:40:34 UTC
...
@@ -833,7 +833,7 @@ void ChromeBrowserMainExtraPartsProfiles::
...
@@ -846,7 +846,7 @@ void ChromeBrowserMainExtraPartsProfiles::
...
+    BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -921,10 +921,10 @@ void ChromeBrowserMainExtraPartsProfiles::
 #endif
...
@@ -1193,7 +1193,7 @@ void ChromeBrowserMainExtraPartsProfiles::
