--- chrome/browser/about_flags.cc.orig	2026-06-17 08:52:30 UTC
...
@@ -918,6 +918,23 @@ const FeatureEntry::FeatureVariation
...
@@ -1342,7 +1359,7 @@ const FeatureEntry::FeatureVariation
          nullptr}};
