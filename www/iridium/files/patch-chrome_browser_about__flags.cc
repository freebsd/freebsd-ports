--- chrome/browser/about_flags.cc.orig	2026-02-16 10:45:29 UTC
...
@@ -3942,7 +3962,7 @@ const flags_ui::FeatureEntry::FeatureVariation
...
@@ -4179,7 +4199,7 @@ const FeatureEntry::FeatureVariation kSensitiveContent
 #endif  // BUILDFLAG(IS_ANDROID)
...
@@ -4963,7 +4983,7 @@ const FeatureEntry::FeatureVariation
 };
...
@@ -5081,7 +5101,7 @@ const FeatureEntry::FeatureVariation kSeamlessSigninVa
      nullptr}};
 #endif  // BUILDFLAG(IS_ANDROID)
...
@@ -5742,7 +5762,7 @@ const FeatureEntry kFeatureEntries[] = {
     },
...
@@ -6226,7 +6246,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -6246,6 +6266,16 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -7088,7 +7118,7 @@ const FeatureEntry kFeatureEntries[] = {
                                     "MlUrlScoring")},
...
+    BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
     {"contextual-search-box-uses-contextual-search-provider",
      ...
      flag_descriptions::
@@ -7485,7 +7515,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -7676,7 +7706,7 @@ const FeatureEntry kFeatureEntries[] = {
                                     "NtpRealboxNext")},
...
@@ -7959,7 +7989,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -8828,7 +8858,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -9366,7 +9396,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -9805,7 +9835,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif
...
@@ -9990,7 +10020,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -10512,7 +10542,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -10527,7 +10557,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN)
...
@@ -11388,7 +11418,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -11786,7 +11816,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // !BUILDFLAG(IS_ANDROID)
...
@@ -11962,7 +11992,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -11977,7 +12007,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -12239,7 +12269,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // BUILDFLAG(IS_ANDROID)
...
@@ -12322,7 +12352,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // BUILDFLAG(IS_ANDROID)
...
@@ -12418,7 +12448,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // BUILDFLAG(IS_ANDROID)
...
@@ -12491,7 +12521,7 @@ const FeatureEntry kFeatureEntries[] = {
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
     {"autofill-enable-buy-now-pay-later-for-externally-linked",
      ...
      flag_descriptions::
@@ -12782,7 +12812,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // !BUILDFLAG(IS_ANDROID),
...
@@ -12924,7 +12954,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -12944,7 +12974,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13015,7 +13045,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13114,7 +13144,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13126,7 +13156,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13134,7 +13164,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13146,7 +13176,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13158,7 +13188,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13170,7 +13200,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13221,7 +13251,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13232,7 +13262,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13251,7 +13281,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13259,7 +13289,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif
...
@@ -13303,7 +13333,7 @@ const FeatureEntry kFeatureEntries[] = {
...
@@ -13321,7 +13351,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif
...
@@ -13334,7 +13364,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif
...
@@ -13407,7 +13437,7 @@ const FeatureEntry kFeatureEntries[] = {
 #endif  // BUILDFLAG(IS_ANDROID)
...
@@ -13504,14 +13534,14 @@ const FeatureEntry kFeatureEntries[] = {
          autofill::features::
