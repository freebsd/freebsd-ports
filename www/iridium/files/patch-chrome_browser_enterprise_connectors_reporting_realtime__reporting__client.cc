--- chrome/browser/enterprise/connectors/reporting/realtime_reporting_client.cc.orig	2026-08-13 16:48:13 UTC
...
@@ -329,7 +329,7 @@ std::string RealtimeReportingClient::GetBrowserClientI
   return client_id;
 }
