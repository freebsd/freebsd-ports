--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2024-12-22 12:24:29 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -292,7 +292,7 @@ void AddA11yStrings(content::WebUIDataSource* html_sou
       {"focusHighlightLabel",
