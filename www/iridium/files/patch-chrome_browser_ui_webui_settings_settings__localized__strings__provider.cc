--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2026-06-10 12:51:34 UTC
...
@@ -558,11 +558,11 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -593,7 +593,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -1836,7 +1836,7 @@ void AddSignOutDialogStrings(content::WebUIDataSource*
