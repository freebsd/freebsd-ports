--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2026-08-13 16:48:13 UTC
...
@@ -609,7 +609,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -617,11 +617,11 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -662,7 +662,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -1971,7 +1971,7 @@ void AddSignOutDialogStrings(content::WebUIDataSource*
