--- base/files/file_util_unittest.cc.orig	2026-06-10 12:51:34 UTC
...
@@ -4993,6 +4993,19 @@ TEST_F(FileUtilTest, CreateDirectoryOnlyCheckMissingSu
...
@@ -5159,7 +5172,7 @@ TEST(FileUtilMultiThreadedTest, MultiThreadedTempFiles
                 NULL);
 #else
