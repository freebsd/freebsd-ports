--- base/files/file_util_unittest.cc.orig	2026-08-13 16:48:13 UTC
...
@@ -5013,6 +5013,19 @@ TEST_F(FileUtilTest, CreateDirectoryOnlyCheckMissingSu
...
@@ -5179,7 +5192,7 @@ TEST(FileUtilMultiThreadedTest, MultiThreadedTempFiles
                 NULL);
 #else
