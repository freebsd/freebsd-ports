--- chrome/browser/metrics/chrome_metrics_service_client.cc.orig	2026-08-13 16:48:13 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   metrics_service_->RegisterMetricsProvider(
@@ -1207,7 +1207,7 @@ bool ChromeMetricsServiceClient::RegisterForProfileEve
   }
 #endif
...
@@ -1557,7 +1557,7 @@ void ChromeMetricsServiceClient::CreateStructuredMetri
   recorder =
