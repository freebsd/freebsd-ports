--- third_party/blink/renderer/core/origin_trials/origin_trial_context.cc.orig	2025-12-10 15:04:57 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
     return false;
@@ -572,7 +572,7 @@ bool OriginTrialContext::CanEnableTrialFromName(const 
