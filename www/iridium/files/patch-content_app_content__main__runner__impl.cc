--- content/app/content_main_runner_impl.cc.orig	2024-08-27 06:28:16 UTC
...
@@ -1058,8 +1073,20 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1168,6 +1195,11 @@ int NO_STACK_PROTECTOR ContentMainRunnerImpl::Run() {
