--- chrome/browser/ui/startup/startup_browser_creator_impl.cc.orig	2026-08-13 16:48:13 UTC
...
@@ -162,7 +162,7 @@ Browser* GetExistingBrowserForOpenBehavior(
...
@@ -321,7 +321,7 @@ Browser* StartupBrowserCreatorImpl::OpenTabsInBrowser(
