--- chrome/browser/renderer_context_menu/render_view_context_menu.cc.orig	2026-01-16 14:21:21 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -5054,7 +5054,7 @@ void RenderViewContextMenu::OpenLinkInSplitView() {
