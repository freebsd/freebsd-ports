--- chrome/browser/renderer_context_menu/render_view_context_menu.cc.orig	2026-02-16 10:45:29 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -5117,7 +5117,7 @@ void RenderViewContextMenu::OpenLinkInSplitView() {
