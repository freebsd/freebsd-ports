--- net/base/features.cc.orig	2026-02-16 10:45:29 UTC
...
@@ -301,7 +301,7 @@ inline constexpr auto kMigrateSessionsOnNetworkChangeV
...
@@ -415,7 +415,7 @@ BASE_FEATURE(kReportingApiEnableEnterpriseCookieIssues
              base::FEATURE_DISABLED_BY_DEFAULT);
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -508,7 +508,7 @@ BASE_FEATURE(kHttpCacheMappedFileFlushWin, base::FEATU
