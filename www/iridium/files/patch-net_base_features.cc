--- net/base/features.cc.orig	2026-01-16 14:21:21 UTC
...
@@ -451,7 +451,7 @@ inline constexpr auto kMigrateSessionsOnNetworkChangeV
...
@@ -554,7 +554,7 @@ BASE_FEATURE(kReportingApiEnableEnterpriseCookieIssues
              base::FEATURE_DISABLED_BY_DEFAULT);
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -644,7 +644,7 @@ BASE_FEATURE(kHttpCacheMappedFileFlushWin, base::FEATU
