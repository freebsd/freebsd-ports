--- gpu/ipc/service/gpu_init.cc.orig	2025-12-10 15:04:57 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   if (gpu_info.gpu.vendor_id != 0x10de ||  // NVIDIA
     ...
     return true;
@@ -418,7 +418,7 @@ bool GpuInit::InitializeAndStartSandbox(base::CommandL
...
@@ -456,7 +456,7 @@ bool GpuInit::InitializeAndStartSandbox(base::CommandL
   }
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
         VLOG(1) << "Quit GPU process launch to fallback to SwiftShader cleanly "
                 << "on Linux";
         return false;
@@ -779,7 +779,7 @@ bool GpuInit::InitializeAndStartSandbox(base::CommandL
...
@@ -831,7 +831,7 @@ bool GpuInit::InitializeAndStartSandbox(base::CommandL
       }
     }
   }
-#if BUILDFLAG(IS_LINUX) || \
...
@@ -1033,7 +1033,7 @@ void GpuInit::InitializeInProcess(base::CommandLine* c
   }
