--- media/gpu/chromeos/video_decoder_pipeline.cc.orig	2026-02-16 10:45:29 UTC
+++ media/gpu/chromeos/video_decoder_pipeline.cc
@@ -1133,7 +1133,7 @@ VideoDecoderPipeline::PickDecoderOutputFormat(
   }
 #endif
...
@@ -1142,7 +1142,7 @@ VideoDecoderPipeline::PickDecoderOutputFormat(
...
@@ -1316,7 +1316,7 @@ VideoDecoderPipeline::PickDecoderOutputFormat(
              << " VideoFrames";
