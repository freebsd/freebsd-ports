--- content/browser/renderer_host/render_process_host_impl.cc.orig	2025-03-18 16:46:04 UTC
...
@@ -5229,7 +5231,7 @@ uint64_t RenderProcessHostImpl::GetPrivateMemoryFootpr
