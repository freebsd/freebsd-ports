--- content/browser/renderer_host/render_process_host_impl.cc.orig	2023-07-24 14:27:53 UTC
...
@@ -3461,6 +3461,8 @@ void RenderProcessHostImpl::PropagateBrowserCommandLin
