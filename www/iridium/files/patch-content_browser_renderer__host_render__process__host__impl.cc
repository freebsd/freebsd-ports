--- content/browser/renderer_host/render_process_host_impl.cc.orig	2023-08-28 20:17:35 UTC
...
@@ -3555,6 +3555,8 @@ void RenderProcessHostImpl::PropagateBrowserCommandLin
