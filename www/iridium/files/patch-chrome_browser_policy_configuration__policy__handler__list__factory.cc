--- chrome/browser/policy/configuration_policy_handler_list_factory.cc.orig	2025-12-10 15:04:57 UTC
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kFullscreenAllowed,
     ...
     base::Value::Type::BOOLEAN },
@@ -1864,7 +1864,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
     base::Value::Type::INTEGER},
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   { key::kDefaultBrowserSettingEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -1977,7 +1977,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
     base::Value::Type::BOOLEAN },
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) \
...
@@ -2866,7 +2866,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
+    BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   signin_legacy_policies.push_back(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3342,7 +3342,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
 #endif
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   handlers->AddHandler(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3403,7 +3403,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
