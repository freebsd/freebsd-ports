--- src/3rdparty/chromium/components/password_manager/core/browser/password_manual_fallback_flow.cc.orig	2026-08-11 12:42:19 UTC
...
@@ -301,7 +301,7 @@ void PasswordManualFallbackFlow::DidAcceptSuggestion(
     }
...
@@ -437,7 +437,7 @@ void PasswordManualFallbackFlow::EnsureCrossDomainPass
