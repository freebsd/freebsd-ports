--- src/3rdparty/chromium/ui/events/ozone/layout/xkb/xkb_keyboard_layout_engine.cc.orig	2026-08-11 12:42:19 UTC
+++ src/3rdparty/chromium/ui/events/ozone/layout/xkb/xkb_keyboard_layout_engine.cc
@@ -648,7 +648,7 @@ void LoadKeymap(const std::string& layout_name,
                           .options = ""};
...
@@ -682,7 +682,7 @@ XkbKeyboardLayoutEngine::XkbKeyboardLayoutEngine(
