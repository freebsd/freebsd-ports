--- src/3rdparty/chromium/content/browser/renderer_host/render_process_host_impl.h.orig	2026-02-26 14:39:03 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -1002,7 +1002,7 @@ class CONTENT_EXPORT RenderProcessHostImpl
...
@@ -1247,7 +1247,7 @@ class CONTENT_EXPORT RenderProcessHostImpl
