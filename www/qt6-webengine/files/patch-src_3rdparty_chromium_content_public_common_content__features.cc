--- src/3rdparty/chromium/content/public/common/content_features.cc.orig	2026-08-11 12:42:19 UTC
...
@@ -1428,9 +1428,9 @@ BASE_FEATURE(kWebAssemblyTiering,
...
@@ -1490,7 +1490,11 @@ BASE_FEATURE(kWebUIJSErrorReportingExtended,
