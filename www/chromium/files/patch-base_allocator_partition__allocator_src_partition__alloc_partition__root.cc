--- base/allocator/partition_allocator/src/partition_alloc/partition_root.cc.orig	2026-01-14 08:33:23 UTC
...
@@ -1011,7 +1011,7 @@ void PartitionRoot::Init(PartitionOptions opts) {
     // apple OSes.
