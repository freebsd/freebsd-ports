...
@@ -38,7 +38,7 @@ BASE_FEATURE(kAutofillEnableAiBasedAmountExtraction,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -61,7 +61,7 @@ BASE_FEATURE(kAutofillEnableBottomSheetScanCardAndFill
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -72,7 +72,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLater,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -82,7 +82,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLaterForExternall
 // offered.
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -91,7 +91,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLaterForKlarna,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -101,7 +101,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLaterSyncing,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -121,7 +121,7 @@ BASE_FEATURE(kAutofillEnableCardBenefitsForAmericanExp
 // UI.
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -165,7 +165,7 @@ BASE_FEATURE(kAutofillEnableFlatRateCardBenefitsBlockl
