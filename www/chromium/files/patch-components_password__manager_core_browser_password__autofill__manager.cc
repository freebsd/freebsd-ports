--- components/password_manager/core/browser/password_autofill_manager.cc.orig	2026-05-07 17:02:56 UTC
+++ components/password_manager/core/browser/password_autofill_manager.cc
@@ -391,7 +391,7 @@ void PasswordAutofillManager::DidAcceptSuggestion(
...
@@ -645,7 +645,7 @@ void PasswordAutofillManager::DidNavigateMainFrame() {
