--- components/password_manager/core/browser/password_autofill_manager.cc.orig	2026-09-25 15:26:43 UTC
+++ components/password_manager/core/browser/password_autofill_manager.cc
@@ -409,7 +409,7 @@ void PasswordAutofillManager::DidAcceptSuggestion(
...
@@ -460,7 +460,7 @@ void PasswordAutofillManager::DidAcceptSuggestion(
...
+    BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
         cross_domain_confirmation_controller_ =
             password_client_->ShowCrossDomainConfirmationPopup(
                 last_popup_open_args_.element_bounds,
@@ -729,7 +729,7 @@ void PasswordAutofillManager::DidNavigateMainFrame() {
