--- content/browser/browser_main_loop.cc.orig	2026-09-25 15:26:43 UTC
...
+
 ...
 #ifdef DestroyAll
 #undef DestroyAll
@@ -548,6 +554,12 @@ int BrowserMainLoop::EarlyInitialization() {
...
@@ -579,7 +591,7 @@ int BrowserMainLoop::EarlyInitialization() {
