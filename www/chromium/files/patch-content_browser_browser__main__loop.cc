--- content/browser/browser_main_loop.cc.orig	2026-08-12 09:02:10 UTC
...
+
 ...
 #ifdef DestroyAll
 #undef DestroyAll
@@ -539,6 +545,12 @@ int BrowserMainLoop::EarlyInitialization() {
...
@@ -570,7 +582,7 @@ int BrowserMainLoop::EarlyInitialization() {
