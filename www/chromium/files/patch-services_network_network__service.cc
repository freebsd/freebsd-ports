--- services/network/network_service.cc.orig	2026-09-25 15:26:43 UTC
...
@@ -1065,7 +1065,7 @@ void NetworkService::SetExplicitlyAllowedPorts(
...
@@ -1208,7 +1208,7 @@ NetworkService::CreateHttpAuthHandlerFactory(NetworkCo
   );
 }
