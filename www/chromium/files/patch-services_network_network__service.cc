--- services/network/network_service.cc.orig	2026-06-04 10:12:25 UTC
...
@@ -1038,7 +1038,7 @@ void NetworkService::SetExplicitlyAllowedPorts(
...
@@ -1178,7 +1178,7 @@ NetworkService::CreateHttpAuthHandlerFactory(NetworkCo
   );
 }
