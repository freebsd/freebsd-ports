--- components/commerce/core/commerce_feature_list.cc.orig	2025-03-05 08:14:56 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kEnableDiscountInfoApiRegionLaunched,
              ...
              base::FEATURE_ENABLED_BY_DEFAULT);
@@ -242,7 +242,7 @@ const char kMerchantWideBehaviorParam[] = "merchant-wi
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kDiscountDialogAutoPopupBehaviorSetting,
              ...
              base::FEATURE_ENABLED_BY_DEFAULT);
@@ -283,7 +283,8 @@ const base::FeatureParam<bool> kDeleteAllMerchantsOnCl
