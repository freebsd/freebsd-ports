--- services/network/network_service.h.orig	2026-09-25 15:26:43 UTC
...
@@ -312,7 +312,7 @@ class COMPONENT_EXPORT(NETWORK_SERVICE) NetworkService
...
@@ -597,7 +597,7 @@ class COMPONENT_EXPORT(NETWORK_SERVICE) NetworkService
