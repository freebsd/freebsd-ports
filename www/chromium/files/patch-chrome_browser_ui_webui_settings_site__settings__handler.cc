--- chrome/browser/ui/webui/settings/site_settings_handler.cc.orig	2026-09-25 15:26:43 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (web_app_provider) {
@@ -2216,7 +2216,7 @@ void SiteSettingsHandler::HandleRemoveZoomLevel(const 
