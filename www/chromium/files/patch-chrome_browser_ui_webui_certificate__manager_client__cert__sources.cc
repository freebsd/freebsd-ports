--- chrome/browser/ui/webui/certificate_manager/client_cert_sources.cc.orig	2026-03-13 06:02:14 UTC
...
@@ -326,7 +326,7 @@ class ClientCertSource : public CertificateManagerPage
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 CreateProvisionedClientCertSource(Profile* profile) {
   return std::make_unique<ClientCertSource>(
@@ -1106,7 +1106,7 @@ bool ClientCertManagementAccessControls::IsChangeAllow
