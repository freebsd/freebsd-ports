--- media/base/media_switches.cc.orig	2026-08-31 10:59:09 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -472,13 +472,35 @@ BASE_FEATURE(kApplicationAudioCaptureMac, base::FEATUR
...
@@ -650,7 +672,7 @@ BASE_FEATURE(kRevokeMediaSourceObjectURLOnAttach,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -660,7 +682,7 @@ BASE_FEATURE(kSymphoniaAudioDecoding,
 // Android / Fuchsia are expected to launch in M150.
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -783,7 +805,7 @@ BASE_FEATURE(kMediaCodecColorSpaceCleanup, base::FEATU
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -802,7 +824,7 @@ BASE_FEATURE(kSuspendMediaForFrozenFrames, base::FEATU
 // autoplay policy.
...
@@ -888,7 +910,7 @@ BASE_FEATURE(kVaapiVp9SModeHWEncoding, base::FEATURE_E
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 BASE_FEATURE(kV4L2H264TemporalLayerHWEncoding,
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -1100,7 +1122,7 @@ BASE_FEATURE(kMediaFoundationMultiGpuAdapterSelection,
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
              ...
              base::FEATURE_ENABLED_BY_DEFAULT
 #else
@@ -1458,7 +1480,7 @@ BASE_FEATURE(kUseOutOfProcessVideoDecoding,
...
@@ -1520,7 +1542,7 @@ BASE_FEATURE(kRecordMediaEngagementScores, base::FEATU
...
@@ -1845,7 +1867,7 @@ bool IsSystemLoopbackCaptureSupported() {
