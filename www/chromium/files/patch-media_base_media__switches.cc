--- media/base/media_switches.cc.orig	2024-09-30 07:45:04 UTC
...
@@ -1463,7 +1485,7 @@ BASE_FEATURE(kUseGTFOOutOfProcessVideoDecoding,
              base::FEATURE_DISABLED_BY_DEFAULT);
...
@@ -1543,7 +1565,7 @@ BASE_FEATURE(kRecordWebAudioEngagement,
