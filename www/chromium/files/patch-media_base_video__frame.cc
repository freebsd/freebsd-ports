--- media/base/video_frame.cc.orig	2023-05-31 08:12:17 UTC
...
@@ -1305,7 +1305,7 @@ const gpu::MailboxHolder& VideoFrame::mailbox_holder(
...
@@ -1418,7 +1418,7 @@ VideoFrame::VideoFrame(const VideoFrameLayout& layout,
