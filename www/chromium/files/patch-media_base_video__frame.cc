--- media/base/video_frame.cc.orig	2025-01-15 09:18:26 UTC
...
@@ -755,7 +755,7 @@ scoped_refptr<VideoFrame> VideoFrame::WrapExternalGpuM
   return frame;
 }
...
@@ -1461,7 +1461,7 @@ scoped_refptr<gpu::ClientSharedImage> VideoFrame::shar
