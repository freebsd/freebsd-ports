--- third_party/libvpx/source/config/linux/arm64/vpx_dsp_rtcd.h.orig	2026-05-07 17:02:56 UTC
+++ third_party/libvpx/source/config/linux/arm64/vpx_dsp_rtcd.h
@@ -885,32 +885,26 @@ uint32_t vpx_sub_pixel_avg_variance8x8_neon(const uint
...
@@ -919,32 +913,26 @@ uint32_t vpx_sub_pixel_variance4x4_neon(const uint8_t 
