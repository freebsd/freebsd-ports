--- chrome/browser/ui/views/frame/horizontal_tab_strip_region_view.cc.orig	2026-08-12 09:02:10 UTC
+++ chrome/browser/ui/views/frame/horizontal_tab_strip_region_view.cc
@@ -251,7 +251,7 @@ HorizontalTabStripRegionView::HorizontalTabStripRegion
