--- media/base/media_switches.h.orig	2026-07-01 06:24:19 UTC
...
@@ -351,7 +363,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kUnifiedAutoplay);
...
@@ -477,7 +489,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kUseOutOfProcessVide
