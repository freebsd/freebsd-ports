--- content/gpu/gpu_main.cc.orig	2024-09-30 07:45:04 UTC
...
@@ -438,7 +443,7 @@ int GpuMain(MainFunctionParams parameters) {
...
@@ -478,7 +483,7 @@ bool StartSandboxLinux(gpu::GpuWatchdogThread* watchdo
