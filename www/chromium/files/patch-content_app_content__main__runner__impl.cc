--- content/app/content_main_runner_impl.cc.orig	2026-09-25 15:26:43 UTC
...
+
 ...
 #include "base/system/sys_info.h"
@@ -379,7 +386,7 @@ void InitializeZygoteSandboxForBrowserProcess(
 }
...
@@ -427,7 +434,10 @@ void PreallocateFileDescriptorTable() {
...
+#endif
   ...
   // files.
@@ -439,9 +449,16 @@ void PreSandboxInit() {
...
@@ -691,7 +708,7 @@ NO_STACK_PROTECTOR int RunZygote(ContentMainDelegate* 
...
@@ -796,7 +813,7 @@ NO_STACK_PROTECTOR int RunOtherNamedProcessTypeMain(
...
@@ -869,7 +886,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -927,11 +944,10 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1065,7 +1081,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1100,7 +1116,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
     // SeatbeltExecServer.
...
@@ -1114,6 +1130,16 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1242,6 +1268,11 @@ NO_STACK_PROTECTOR int ContentMainRunnerImpl::Run() {
