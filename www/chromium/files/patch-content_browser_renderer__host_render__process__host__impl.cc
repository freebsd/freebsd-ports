--- content/browser/renderer_host/render_process_host_impl.cc.orig	2023-01-11 09:17:16 UTC
...
@@ -3284,6 +3284,7 @@ void RenderProcessHostImpl::PropagateBrowserCommandLin
...
@@ -4757,7 +4758,7 @@ void RenderProcessHostImpl::ResetIPC() {
