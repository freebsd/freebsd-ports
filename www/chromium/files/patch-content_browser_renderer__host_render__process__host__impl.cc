--- content/browser/renderer_host/render_process_host_impl.cc.orig	2023-05-31 08:12:17 UTC
...
@@ -2182,7 +2182,7 @@ void RenderProcessHostImpl::ReinitializeLogging(
 }
...
@@ -4908,7 +4909,7 @@ void RenderProcessHostImpl::ResetIPC() {
