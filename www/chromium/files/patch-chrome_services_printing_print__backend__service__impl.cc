--- chrome/services/printing/print_backend_service_impl.cc.orig	2023-04-28 17:01:32 UTC
...
@@ -503,7 +503,7 @@ void PrintBackendServiceImpl::Init(
   // `InitCommon()`.
...
@@ -714,7 +714,7 @@ void PrintBackendServiceImpl::UpdatePrintSettings(
