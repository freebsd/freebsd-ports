--- remoting/host/remoting_me2me_host.cc.orig	2026-05-07 17:02:56 UTC
...
@@ -424,7 +424,7 @@ class HostProcess : public ConfigWatcher::Delegate,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_WIN)
@@ -456,7 +456,7 @@ class HostProcess : public ConfigWatcher::Delegate,
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
@@ -524,7 +524,7 @@ class HostProcess : public ConfigWatcher::Delegate,
...
@@ -937,7 +937,7 @@ void HostProcess::CreateAuthenticatorFactory() {
...
@@ -1266,7 +1266,7 @@ void HostProcess::BindRemotingHostControl(
