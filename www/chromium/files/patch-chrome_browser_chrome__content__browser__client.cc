--- chrome/browser/chrome_content_browser_client.cc.orig	2026-05-07 17:02:56 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!content::AreIsolatedWebAppsEnabled(browser_context)) {
     return false;
@@ -2798,7 +2798,9 @@ void MaybeAppendBlinkSettingsSwitchForFieldTrial(
...
@@ -4157,7 +4159,7 @@ GetPreferredColorScheme(const WebPreferences& web_pref
...
@@ -7459,7 +7461,7 @@ bool ChromeContentBrowserClient::ShouldSandboxNetworkS
