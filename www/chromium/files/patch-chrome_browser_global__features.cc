--- chrome/browser/global_features.cc.orig	2026-08-31 10:59:09 UTC
...
@@ -195,7 +195,7 @@ void GlobalFeatures::PostBrowserProcessInitCore() {
   }
 #endif
...
@@ -281,7 +281,7 @@ void GlobalFeatures::PostMainMessageLoopRun() {
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -300,7 +300,7 @@ GlobalFeatures::CreateSystemPermissionsPlatformHandle(
