--- gpu/ipc/service/gpu_init.cc.orig	2023-04-28 17:01:32 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
         VLOG(1) << "Quit GPU process launch to fallback to SwiftShader cleanly "
                 << "on Linux";
         return false;
@@ -665,7 +665,7 @@ bool GpuInit::InitializeAndStartSandbox(base::CommandL
...
@@ -719,7 +719,7 @@ bool GpuInit::InitializeAndStartSandbox(base::CommandL
       }
     }
   }
