--- chrome/browser/ui/views/profiles/first_run_flow_controller.cc.orig	2026-05-07 17:02:56 UTC
...
@@ -633,7 +633,7 @@ std::string FirstRunFlowController::GetHatsSurveyTrigg
 }
