--- chrome/browser/supervised_user/supervised_user_navigation_observer.cc.orig	2026-09-25 15:26:43 UTC
...
@@ -77,7 +77,7 @@ std::unique_ptr<supervised_user::WebContentHandler> Cr
