--- base/allocator/partition_allocator/src/partition_alloc/spinning_mutex.cc.orig	2026-09-25 15:26:43 UTC
...
@@ -151,8 +160,16 @@ PA_ALWAYS_INLINE long FutexSyscall(volatile void* ftx,
