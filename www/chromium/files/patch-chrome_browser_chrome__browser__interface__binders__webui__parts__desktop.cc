--- chrome/browser/chrome_browser_interface_binders_webui_parts_desktop.cc.orig	2026-08-12 09:02:10 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
       NewTabPageUI>(map);
@@ -585,7 +585,7 @@ void PopulateChromeWebUIFrameBindersPartsDesktop(
...
@@ -609,7 +609,7 @@ void PopulateChromeWebUIFrameBindersPartsDesktop(
