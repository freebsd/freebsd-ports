--- chrome/browser/metrics/chrome_metrics_service_client.cc.orig	2026-02-11 09:05:39 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "chrome/browser/ui/tabs/tab_metrics_provider.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -251,7 +251,7 @@ const int kMaxHistogramGatheringWaitDuration = 60000; 
...
@@ -561,7 +561,7 @@ void ChromeMetricsServiceClient::RegisterPrefs(PrefReg
...
@@ -654,7 +654,7 @@ std::string ChromeMetricsServiceClient::GetVersionStri
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   // an environment set.
@@ -754,7 +754,7 @@ void ChromeMetricsServiceClient::Initialize() {
         this, local_state);
   }
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || (BUILDFLAG(IS_LINUX)
@@ -1227,7 +1227,7 @@ bool ChromeMetricsServiceClient::RegisterForProfileEve
   }
 #endif
...
@@ -1578,7 +1578,7 @@ void ChromeMetricsServiceClient::CreateStructuredMetri
   recorder =
