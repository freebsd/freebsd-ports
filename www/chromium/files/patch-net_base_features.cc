--- net/base/features.cc.orig	2026-03-13 06:02:14 UTC
...
@@ -297,7 +297,7 @@ inline constexpr auto kMigrateSessionsOnNetworkChangeV
...
@@ -409,7 +409,7 @@ BASE_FEATURE(kReportingApiEnableEnterpriseCookieIssues
              base::FEATURE_DISABLED_BY_DEFAULT);
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -517,7 +517,7 @@ BASE_FEATURE(kHttpCacheMappedFileFlushWin, base::FEATU
