--- chrome/browser/flag_descriptions.h.orig	2025-03-05 08:14:56 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2026,7 +2026,7 @@ extern const char kDefaultSiteInstanceGroupsName[];
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2189,7 +2189,7 @@ extern const char kTouchTextEditingRedesignDescription
...
@@ -3156,7 +3156,7 @@ extern const char kUserDisplayModeSyncBrowserMitigatio
...
@@ -4358,7 +4358,7 @@ extern const char kTetheringExperimentalFunctionalityD
...
@@ -4556,7 +4559,7 @@ extern const char kScreenlockReauthCardDescription[];
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
@@ -4570,7 +4573,7 @@ extern const char kTaskManagerDesktopRefreshName[];
...
@@ -4667,7 +4670,7 @@ extern const char kElementCaptureDescription[];
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -4709,7 +4712,7 @@ extern const char kComposeUpfrontInputModesName[];
...
@@ -4790,7 +4793,7 @@ extern const char kEnablePolicyPromotionBannerName[];
