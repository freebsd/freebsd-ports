--- components/signin/public/base/signin_switches.cc.orig	2026-05-07 17:02:56 UTC
...
@@ -482,7 +482,7 @@ BASE_FEATURE(kMigrateAccountManagerDelegate, base::FEA
...
@@ -628,7 +628,7 @@ BASE_FEATURE(kStableDeviceId, base::FEATURE_DISABLED_B
