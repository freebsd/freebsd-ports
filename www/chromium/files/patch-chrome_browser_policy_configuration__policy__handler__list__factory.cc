--- chrome/browser/policy/configuration_policy_handler_list_factory.cc.orig	2026-08-12 09:02:10 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kNTPFooterManagementNoticeEnabled,
     ...
     base::Value::Type::BOOLEAN },
@@ -2546,7 +2546,7 @@ const PolicyToPreferenceMapEntry kSimplePolicyMap[] = 
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kEnableProxyOverrideRulesForAllUsers,
     ...
     base::Value::Type::INTEGER },
@@ -2737,7 +2737,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -2891,7 +2891,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -3016,7 +3016,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -3117,7 +3117,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
+    BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   signin_legacy_policies.push_back(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3134,7 +3134,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
           base::Value::Type::BOOLEAN)));
...
@@ -3505,7 +3505,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
 #endif
...
@@ -3513,7 +3513,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   handlers->AddHandler(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3566,7 +3566,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -3703,7 +3703,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
