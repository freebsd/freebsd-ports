--- chrome/browser/policy/configuration_policy_handler_list_factory.cc.orig	2026-02-11 09:05:39 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   { key::kEnableProxyOverrideRulesForAllUsers,
     ...
     base::Value::Type::INTEGER },
@@ -2617,7 +2617,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -2892,7 +2892,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
@@ -2994,7 +2994,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
...
+    BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   signin_legacy_policies.push_back(std::make_unique<SimplePolicyHandler>(
       ...
       base::Value::Type::BOOLEAN));
@@ -3377,7 +3377,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
 #endif
...
@@ -3385,7 +3385,7 @@ std::unique_ptr<ConfigurationPolicyHandlerList> BuildH
