--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-09-25 15:26:43 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -432,7 +432,7 @@ bool PageLoadMetricsEmbedder::IsInternalWebUI(const GU
