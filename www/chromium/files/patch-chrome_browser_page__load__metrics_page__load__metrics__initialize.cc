--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-08-31 10:59:09 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -433,7 +433,7 @@ bool PageLoadMetricsEmbedder::IsInternalWebUI(const GU
