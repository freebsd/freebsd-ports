--- chrome/browser/ui/browser_window/internal/browser_window_features.cc.orig	2026-02-11 09:05:39 UTC
...
@@ -435,7 +435,7 @@ void BrowserWindowFeatures::Init(BrowserWindowInterfac
