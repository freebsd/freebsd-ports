--- chrome/browser/chrome_content_browser_client_navigation_throttles.cc.orig	2026-09-25 15:26:43 UTC
...
@@ -446,7 +446,7 @@ void CreateAndAddChromeThrottlesForNavigation(
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
   ...
   profile_management::ProfileManagementNavigationThrottle::MaybeCreateAndAdd(
       registry);
@@ -464,7 +464,7 @@ void CreateAndAddChromeThrottlesForNavigation(
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   enterprise_connectors::DeviceTrustNavigationThrottle::MaybeCreateAndAdd(
       registry);
 #endif  // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) ||
@@ -519,7 +519,7 @@ void CreateAndAddChromeThrottlesForNavigation(
       registry, ui_manager);
