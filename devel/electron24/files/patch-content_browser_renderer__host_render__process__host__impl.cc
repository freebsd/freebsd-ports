--- content/browser/renderer_host/render_process_host_impl.cc.orig	2023-04-10 14:01:55 UTC
...
@@ -2160,7 +2160,7 @@ void RenderProcessHostImpl::ReinitializeLogging(
 }
...
@@ -3337,6 +3337,7 @@ void RenderProcessHostImpl::PropagateBrowserCommandLin
...
@@ -4817,7 +4818,7 @@ void RenderProcessHostImpl::ResetIPC() {
