--- chrome/browser/ui/webui/infobar_internals/infobar_internals_handler.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -49,7 +49,7 @@ void InfoBarInternalsHandler::GetInfoBars(GetInfoBarsC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   infobar_list.emplace_back(InfoBarEntry::New(
       ...
       /*description=*/
@@ -79,7 +79,7 @@ bool InfoBarInternalsHandler::TriggerInfoBarInternal(I
