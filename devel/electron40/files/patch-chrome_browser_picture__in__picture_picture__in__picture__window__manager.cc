--- chrome/browser/picture_in_picture/picture_in_picture_window_manager.cc.orig	2026-01-18 20:29:18 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -586,7 +586,7 @@ bool PictureInPictureWindowManager::IsSupportedForDocu
