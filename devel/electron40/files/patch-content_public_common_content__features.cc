--- content/public/common/content_features.cc.orig	2026-01-07 00:52:53 UTC
+++ content/public/common/content_features.cc
@@ -117,7 +117,7 @@ BASE_FEATURE(kAudioServiceOutOfProcess,
...
@@ -1146,10 +1146,10 @@ BASE_FEATURE(kWebAssemblyTrapHandler,
...
+    ((BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_MAC)) && \
      defined(ARCH_CPU_ARM64))
              base::FEATURE_ENABLED_BY_DEFAULT
 #else
@@ -1206,7 +1206,11 @@ BASE_FEATURE(kWebUIInProcessResourceLoadingV2,
