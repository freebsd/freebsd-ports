--- remoting/host/remoting_me2me_host.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -201,7 +201,7 @@ const char kStdinConfigPath[] = "-";
...
@@ -838,7 +838,7 @@ void HostProcess::ShutdownOnNetworkThread() {
