--- chrome/browser/ui/ui_features.cc.orig	2026-01-07 00:52:53 UTC
+++ chrome/browser/ui/ui_features.cc
@@ -29,7 +29,7 @@ BASE_FEATURE(kCreateNewTabGroupAppMenuTopLevel,
...
@@ -89,7 +89,7 @@ BASE_FEATURE(kReloadSelectionModel,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -99,7 +99,7 @@ BASE_FEATURE(kCloseActiveTabInSplitViewViaHotkey,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -112,7 +112,7 @@ BASE_FEATURE(kSideBySide,
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
                    0
@@ -196,7 +196,7 @@ BASE_FEATURE(kSideBySideDropTargetNudge,
 );
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -278,7 +278,7 @@ BASE_FEATURE(kSideBySideSessionRestore,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -292,7 +292,7 @@ BASE_FEATURE(kSideBySideLinkMenuNewBadge,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -513,7 +513,7 @@ BASE_FEATURE(kViewsJSAppModalDialog, base::FEATURE_DIS
