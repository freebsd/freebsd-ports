--- third_party/perfetto/src/base/utils.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -294,14 +295,22 @@ std::string GetCurExecutablePath() {
...
@@ -365,7 +374,8 @@ bool IsSyncMemoryTaggingEnabled() {
 }
