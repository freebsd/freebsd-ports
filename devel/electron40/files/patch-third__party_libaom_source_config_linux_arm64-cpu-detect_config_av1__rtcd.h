--- third_party/libaom/source/config/linux/arm64-cpu-detect/config/av1_rtcd.h.orig	2026-01-27 00:55:35 UTC
+++ third_party/libaom/source/config/linux/arm64-cpu-detect/config/av1_rtcd.h
@@ -198,8 +198,6 @@ void av1_dist_wtd_convolve_y_neon(const uint8_t *src, 
...
@@ -285,9 +283,9 @@ void av1_fwht4x4_neon(const int16_t *input, tran_low_t
