--- content/app/content_main_runner_impl.cc.orig	2026-01-18 20:29:18 UTC
...
+
 ...
 #include "base/system/sys_info.h"
@@ -386,7 +393,7 @@ void InitializeZygoteSandboxForBrowserProcess(
 }
...
@@ -405,7 +412,10 @@ void PreSandboxInit() {
...
+#endif
   ...
   // files.
@@ -417,9 +427,16 @@ void PreSandboxInit() {
...
@@ -639,7 +656,7 @@ NO_STACK_PROTECTOR int RunZygote(ContentMainDelegate* 
...
@@ -738,7 +755,7 @@ NO_STACK_PROTECTOR int RunOtherNamedProcessTypeMain(
...
@@ -856,11 +873,10 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1012,7 +1028,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
     // SeatbeltExecServer.
...
@@ -1022,10 +1038,22 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1127,6 +1155,11 @@ NO_STACK_PROTECTOR int ContentMainRunnerImpl::Run() {
