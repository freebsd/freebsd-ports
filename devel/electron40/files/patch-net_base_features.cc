--- net/base/features.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -451,7 +451,7 @@ BASE_FEATURE(kMigrateSessionsOnNetworkChangeV2,
...
@@ -554,7 +554,7 @@ BASE_FEATURE(kSimdutfBase64Support,
              base::FEATURE_DISABLED_BY_DEFAULT);
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -644,7 +644,7 @@ BASE_FEATURE(kHttpCacheNoVarySearch,
