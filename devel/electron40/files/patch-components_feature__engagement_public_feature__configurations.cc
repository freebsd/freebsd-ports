--- components/feature_engagement/public/feature_configurations.cc.orig	2026-01-07 00:52:53 UTC
+++ components/feature_engagement/public/feature_configurations.cc
@@ -103,7 +103,7 @@ std::optional<FeatureConfig> GetClientSideFeatureConfi
