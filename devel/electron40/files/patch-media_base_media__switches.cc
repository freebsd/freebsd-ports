--- media/base/media_switches.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -399,13 +399,35 @@ BASE_FEATURE(kUseSCContentSharingPicker, base::FEATURE
...
@@ -644,7 +666,7 @@ BASE_FEATURE(kGlobalMediaControls,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -685,7 +707,7 @@ BASE_FEATURE(kUnifiedAutoplay, base::FEATURE_ENABLED_B
 // autoplay policy.
...
@@ -741,7 +763,7 @@ BASE_FEATURE(kVSyncMjpegDecoding, base::FEATURE_DISABL
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 BASE_FEATURE(kV4L2H264TemporalLayerHWEncoding,
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -1243,7 +1265,7 @@ BASE_FEATURE(kUseSharedImageInOOPVDProcess, base::FEAT
...
@@ -1305,7 +1327,7 @@ BASE_FEATURE(kRecordWebAudioEngagement, base::FEATURE_
...
@@ -1581,7 +1603,7 @@ bool IsSystemLoopbackCaptureSupported() {
