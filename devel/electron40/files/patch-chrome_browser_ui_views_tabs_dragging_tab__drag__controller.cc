--- chrome/browser/ui/views/tabs/dragging/tab_drag_controller.cc.orig	2026-01-07 00:52:53 UTC
+++ chrome/browser/ui/views/tabs/dragging/tab_drag_controller.cc
@@ -176,7 +176,7 @@ void UpdateSystemDnDDragImage(TabDragContext* attached
