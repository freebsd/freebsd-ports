--- electron/shell/browser/native_window_views.cc.orig	2026-01-15 18:39:20 UTC
...
@@ -502,7 +502,7 @@ void NativeWindowViews::SetGTKDarkThemeEnabled(bool us
 }
...
@@ -563,7 +563,7 @@ void NativeWindowViews::Show() {
...
@@ -579,7 +579,7 @@ void NativeWindowViews::ShowInactive() {
...
@@ -598,7 +598,7 @@ void NativeWindowViews::Hide() {
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -629,7 +629,7 @@ bool NativeWindowViews::IsEnabled() const {
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   NOTIMPLEMENTED();
@@ -863,7 +863,7 @@ void NativeWindowViews::SetBounds(const gfx::Rect& bou
   }
 #endif
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   if (!CanResize()) {
@@ -1123,7 +1123,7 @@ bool NativeWindowViews::IsClosable() const {
     return false;
   }
...
@@ -1163,7 +1163,7 @@ void NativeWindowViews::Center() {
