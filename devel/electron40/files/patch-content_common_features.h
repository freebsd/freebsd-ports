--- content/common/features.h.orig	2026-01-18 20:29:18 UTC
+++ content/common/features.h
@@ -67,7 +67,7 @@ CONTENT_EXPORT BASE_DECLARE_FEATURE(kDocumentPolicyNeg
...
@@ -106,7 +106,7 @@ CONTENT_EXPORT BASE_DECLARE_FEATURE_PARAM(FontDataServ
