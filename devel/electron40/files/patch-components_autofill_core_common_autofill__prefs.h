--- components/autofill/core/common/autofill_prefs.h.orig	2026-01-07 00:52:53 UTC
+++ components/autofill/core/common/autofill_prefs.h
@@ -55,7 +55,7 @@ inline constexpr char kAutofillAiTravelEntitiesEnabled
...
@@ -294,7 +294,7 @@ void SetFacilitatedPaymentsA2ATriggeredOnce(PrefServic
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 void SetAutofillBnplEnabled(PrefService* prefs, bool value);
         ...
         // BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID)
@@ -302,7 +302,7 @@ bool IsAutofillBnplEnabled(const PrefService* prefs);
