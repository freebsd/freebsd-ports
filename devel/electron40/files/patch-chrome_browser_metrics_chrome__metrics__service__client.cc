--- chrome/browser/metrics/chrome_metrics_service_client.cc.orig	2026-01-27 00:55:35 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "chrome/browser/ui/tabs/tab_metrics_provider.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -249,7 +249,7 @@ const char kCrashpadHistogramAllocatorName[] = "Crashp
...
@@ -653,7 +653,7 @@ void ChromeMetricsServiceClient::OnEnvironmentUpdate(s
