--- components/feature_engagement/public/feature_constants.cc.orig	2026-01-07 00:52:53 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
 ...
 BASE_FEATURE(kEsbDownloadRowPromoFeature,
              "EsbDownloadRowPromo",
@@ -226,7 +226,7 @@ BASE_FEATURE(kIPHSideBySidePinnableFeature,
...
@@ -234,7 +234,7 @@ BASE_FEATURE(kIPHSideBySideTabSwitchFeature,
 );
