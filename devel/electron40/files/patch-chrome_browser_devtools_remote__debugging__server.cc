--- chrome/browser/devtools/remote_debugging_server.cc.orig	2026-01-07 00:52:53 UTC
+++ chrome/browser/devtools/remote_debugging_server.cc
@@ -49,7 +49,7 @@ bool g_tethering_enabled = false;
...
@@ -179,7 +179,7 @@ IsRemoteDebuggingAllowed(const std::optional<bool>& is
