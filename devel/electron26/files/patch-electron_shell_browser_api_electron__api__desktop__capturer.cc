--- electron/shell/browser/api/electron_api_desktop_capturer.cc.orig	2023-08-14 18:19:06 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 std::map<x11::RandR::Output, int> GetMonitors(int version,
                                               x11::RandR* randr,
@@ -374,7 +374,7 @@ void DesktopCapturer::UpdateSourcesList(DesktopMediaLi
