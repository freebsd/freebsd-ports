--- chrome/browser/ui/ui_features.h.orig	2026-08-24 20:59:34 UTC
+++ chrome/browser/ui/ui_features.h
@@ -30,7 +30,7 @@ BASE_DECLARE_FEATURE(kCtrlTabMru);
...
@@ -84,7 +84,7 @@ BASE_DECLARE_FEATURE_PARAM(int, kSeparateDefaultAndPin
...
@@ -280,7 +280,7 @@ BASE_DECLARE_FEATURE(kViewsJSAppModalDialog);
