--- chrome/browser/enterprise/signals/context_info_fetcher.cc.orig	2026-03-13 16:54:03 UTC
+++ chrome/browser/enterprise/signals/context_info_fetcher.cc
@@ -184,6 +184,8 @@ SettingValue ContextInfoFetcher::GetOSFirewall() {
...
+  return SettingValue::ENABLED;
 ...
 #else
@@ -203,7 +205,7 @@ std::vector<std::string> ContextInfoFetcher::GetDnsSer
