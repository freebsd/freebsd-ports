--- electron/spec/chromium-spec.ts.orig	2026-09-08 02:42:44 UTC
+++ electron/spec/chromium-spec.ts
@@ -605,15 +605,15 @@ describe('command line switches', () => {
...
@@ -4246,12 +4246,12 @@ describe('font fallback', () => {
...
+  ifit(process.platform !== 'linux' && process.platform !== 'freebsd')(
     ...
     async function () {
       const html = `
@@ -4930,7 +4930,7 @@ describe('paste execCommand', () => {
   });
 });
 
-ifdescribe(process.platform !== 'linux')('navigator.setAppBadge/clearAppBadge', () => {
+ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('navigator.setAppBadge/clearAppBadge', () => {
   let w: BrowserWindow;
