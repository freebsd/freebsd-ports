--- chrome/browser/chrome_content_browser_client.cc.orig	2026-08-24 20:59:34 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!content::AreIsolatedWebAppsEnabled(browser_context)) {
     return false;
@@ -2911,7 +2911,9 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4169,7 +4171,7 @@ std::optional<SkColor> GetRootScrollbarThemeColor(WebC
...
@@ -7676,7 +7678,7 @@ bool ChromeContentBrowserClient::ShouldRunOutOfProcess
