--- electron/spec/api-browser-window-spec.ts.orig	2026-09-18 15:43:03 UTC
...
@@ -1517,7 +1517,7 @@ describe('BrowserWindow module', () => {
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not be visible when the window is minimized', async () => {
         ...
         w.minimize();
         await minimize;
@@ -1534,7 +1534,7 @@ describe('BrowserWindow module', () => {
       });
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore maximized windows', async () => {
         ...
         w.maximize();
@@ -1599,7 +1599,7 @@ describe('BrowserWindow module', () => {
...
@@ -1704,7 +1704,7 @@ describe('BrowserWindow module', () => {
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Maximized state', () => {
         it('checks normal bounds when maximized', async () => {
           ...
           const maximize = once(w, 'maximize');
@@ -2472,7 +2472,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Minimized state', () => {
         it('checks normal bounds when minimized', async () => {
           const bounds = w.getBounds();
           const minimize = once(w, 'minimize');
@@ -3835,7 +3835,7 @@ describe('BrowserWindow module', () => {
...
+        if ((process.platform !== 'linux' && process.platform !== 'freebsd') && !w.isMaximized()) {
           ...
           w.show();
           w.maximize();
@@ -5090,7 +5090,7 @@ describe('BrowserWindow module', () => {
...
@@ -5606,7 +5606,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -5882,7 +5882,7 @@ describe('BrowserWindow module', () => {
     // TODO(zcbenz):
...
@@ -5900,7 +5900,7 @@ describe('BrowserWindow module', () => {
       }
     );
...
@@ -5923,7 +5923,7 @@ describe('BrowserWindow module', () => {
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('BrowserWindow.maximize()', () => {
     ...
     it('should show the window if it is not currently shown', async () => {
       const w = new BrowserWindow({ show: false });
@@ -5960,7 +5960,7 @@ describe('BrowserWindow module', () => {
...
+    ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore a minimized window', async () => {
       ...
       const minimize = once(w, 'minimize');
       w.minimize();
@@ -6473,7 +6473,7 @@ describe('BrowserWindow module', () => {
       });
...
@@ -6714,7 +6714,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
@@ -8072,7 +8072,7 @@ describe('BrowserWindow module', () => {
