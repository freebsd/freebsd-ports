--- third_party/libvpx/source/config/linux/arm64/vpx_dsp_rtcd.h.orig	2026-04-28 21:06:17 UTC
+++ third_party/libvpx/source/config/linux/arm64/vpx_dsp_rtcd.h
@@ -885,32 +885,26 @@ uint32_t vpx_sub_pixel_variance16x16_neon(const uint8_
...
@@ -919,32 +913,26 @@ uint32_t vpx_sub_pixel_variance4x8_neon(const uint8_t 
...
@@ -1186,29 +1174,17 @@ static void setup_rtcd_internal(void)
