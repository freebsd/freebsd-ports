--- chrome/browser/ui/views/frame/opaque_browser_frame_view.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -596,7 +596,7 @@ OpaqueBrowserFrameView::GetFrameButtonStyle() const {
...
@@ -859,7 +859,7 @@ void OpaqueBrowserFrameView::WindowIconPressed() {
 }
