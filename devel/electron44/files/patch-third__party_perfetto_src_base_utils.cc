--- third_party/perfetto/src/base/utils.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -244,14 +245,22 @@ std::string GetCurExecutablePath() {
...
@@ -315,7 +324,8 @@ bool IsSyncMemoryTaggingEnabled() {
 }
