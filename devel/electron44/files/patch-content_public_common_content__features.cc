--- content/public/common/content_features.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -160,7 +160,7 @@ BASE_FEATURE(kAudioServiceSandbox,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -1268,10 +1268,10 @@ BASE_FEATURE(kWebAssemblyTrapHandler,
