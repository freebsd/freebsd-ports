--- services/network/network_service.h.orig	2026-08-24 20:59:34 UTC
...
@@ -313,7 +313,7 @@ class COMPONENT_EXPORT(NETWORK_SERVICE) NetworkService
...
@@ -600,7 +600,7 @@ class COMPONENT_EXPORT(NETWORK_SERVICE) NetworkService
