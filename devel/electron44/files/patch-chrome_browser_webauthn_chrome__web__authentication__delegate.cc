--- chrome/browser/webauthn/chrome_web_authentication_delegate.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -377,7 +377,7 @@ ChromeWebAuthenticationDelegate::MaybeGetRequestProxy(
