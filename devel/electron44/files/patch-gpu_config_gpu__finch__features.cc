--- gpu/config/gpu_finch_features.cc.orig	2026-08-24 20:59:34 UTC
+++ gpu/config/gpu_finch_features.cc
@@ -189,7 +189,7 @@ BASE_FEATURE(kRemoveGPULegacyIPC, base::FEATURE_DISABL
...
@@ -513,7 +513,7 @@ const base::FeatureParam<int> kGPUDriverBugListTestGro
