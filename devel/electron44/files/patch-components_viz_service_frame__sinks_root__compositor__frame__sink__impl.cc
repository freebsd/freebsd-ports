--- components/viz/service/frame_sinks/root_compositor_frame_sink_impl.cc.orig	2026-09-01 23:50:56 UTC
...
@@ -939,7 +939,7 @@ void RootCompositorFrameSinkImpl::DisplayDidCompleteSw
