--- components/signin/public/base/signin_switches.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -84,7 +84,7 @@ BASE_FEATURE(kAvoidAutoTriggerListAccountsOnStale,
...
@@ -290,7 +290,7 @@ BASE_FEATURE(kDiceLinkedAccounts, base::FEATURE_DISABL
...
@@ -560,7 +560,7 @@ BASE_FEATURE(kFetchAccountInfoOnRestart, base::FEATURE
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kFirstRunFeatureShowcaseGeminiStep,
              base::FEATURE_DISABLED_BY_DEFAULT);
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
@@ -697,7 +697,7 @@ BASE_FEATURE(kNonDefaultGaiaOriginCheck, base::FEATURE
...
@@ -818,7 +818,7 @@ BASE_FEATURE(kSupportAddSessionEmailPrefill, base::FEA
