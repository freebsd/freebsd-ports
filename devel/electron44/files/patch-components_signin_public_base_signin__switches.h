--- components/signin/public/base/signin_switches.h.orig	2026-08-24 20:59:34 UTC
+++ components/signin/public/base/signin_switches.h
@@ -62,7 +62,7 @@ BASE_DECLARE_FEATURE(kAvoidAutoTriggerListAccountsOnSt
...
@@ -238,7 +238,7 @@ extern const base::FeatureParam<std::string> kCrossDev
...
@@ -264,7 +264,7 @@ BASE_DECLARE_FEATURE(kDiceLinkedAccounts);
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 COMPONENT_EXPORT(SIGNIN_SWITCHES)
@@ -453,7 +453,7 @@ BASE_DECLARE_FEATURE(kFetchAccountInfoOnRestart);
 COMPONENT_EXPORT(SIGNIN_SWITCHES)
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 //
@@ -517,7 +517,7 @@ BASE_DECLARE_FEATURE(kFirstRunDesktopRefreshSurvey);
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 //
@@ -537,7 +537,7 @@ bool IsFirstRunDesktopRevampEnabled(bool is_in_search_
...
@@ -548,7 +548,7 @@ BASE_DECLARE_FEATURE(kFirstRunDesktopRevampNoFeatureSh
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 // Feature Showcase.
@@ -559,7 +559,7 @@ BASE_DECLARE_FEATURE(kFirstRunDesktopRevampSurvey);
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 //
@@ -660,7 +660,7 @@ BASE_DECLARE_FEATURE(kNonDefaultGaiaOriginCheck);
 COMPONENT_EXPORT(SIGNIN_SWITCHES)
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 //
@@ -679,7 +679,7 @@ bool IsPreFirstRunDesktopRefreshEnabled(bool is_in_sea
...
@@ -796,7 +796,7 @@ BASE_DECLARE_FEATURE(kSupportAddSessionEmailPrefill);
