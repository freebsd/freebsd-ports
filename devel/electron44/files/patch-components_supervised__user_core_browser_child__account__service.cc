--- components/supervised_user/core/browser/child_account_service.cc.orig	2026-08-24 20:59:34 UTC
+++ components/supervised_user/core/browser/child_account_service.cc
@@ -163,7 +163,7 @@ void ChildAccountService::UpdateForceGoogleSafeSearch(
