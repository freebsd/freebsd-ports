--- electron/spec/api-utility-process-spec.ts.orig	2026-09-15 22:52:01 UTC
+++ electron/spec/api-utility-process-spec.ts
@@ -593,7 +593,7 @@ describe('utilityProcess module', () => {
...
@@ -630,7 +630,7 @@ describe('utilityProcess module', () => {
       await closeWindow(w);
     });
