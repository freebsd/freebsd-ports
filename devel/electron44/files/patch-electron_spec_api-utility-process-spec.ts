--- electron/spec/api-utility-process-spec.ts.orig	2026-09-08 02:42:44 UTC
+++ electron/spec/api-utility-process-spec.ts
@@ -592,7 +592,7 @@ describe('utilityProcess module', () => {
...
@@ -629,7 +629,7 @@ describe('utilityProcess module', () => {
       await closeWindow(w);
     });
