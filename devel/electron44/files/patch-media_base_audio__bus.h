--- media/base/audio_bus.h.orig	2026-08-24 20:59:34 UTC
...
@@ -298,6 +360,17 @@ void AudioBus::FromInterleaved(
...
@@ -318,6 +391,16 @@ void AudioBus::FromInterleavedPartial(
...
@@ -332,6 +415,15 @@ void AudioBus::ToInterleaved(
...
@@ -340,6 +432,16 @@ void AudioBus::ToInterleavedPartial(
