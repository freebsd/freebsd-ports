--- content/app/content_main_runner_impl.cc.orig	2026-09-01 23:50:56 UTC
...
+
 ...
 #include "base/system/sys_info.h"
@@ -373,7 +380,7 @@ void InitializeZygoteSandboxForBrowserProcess(
 }
...
@@ -392,7 +399,10 @@ void PreSandboxInit() {
...
+#endif
   ...
   // files.
@@ -404,9 +414,16 @@ void PreSandboxInit() {
...
@@ -642,7 +659,7 @@ NO_STACK_PROTECTOR int RunZygote(ContentMainDelegate* 
...
@@ -746,7 +763,7 @@ NO_STACK_PROTECTOR int RunOtherNamedProcessTypeMain(
...
@@ -867,11 +884,10 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1005,7 +1021,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1040,7 +1056,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
     // SeatbeltExecServer.
...
@@ -1054,6 +1070,16 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1170,6 +1196,11 @@ NO_STACK_PROTECTOR int ContentMainRunnerImpl::Run() {
