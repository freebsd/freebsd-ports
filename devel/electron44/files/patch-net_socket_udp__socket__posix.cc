--- net/socket/udp_socket_posix.cc.orig	2026-08-24 20:59:34 UTC
...
+
 ...
 namespace {
@@ -87,7 +91,7 @@ constexpr int kPortEnd = 65535;
...
@@ -310,7 +318,7 @@ void UDPSocketPosix::ConfigureGroSocketOption() {
 #endif
...
+#elif BUILDFLAG(IS_APPLE) || BUILDFLAG(IS_BSD)
   if (last_error == EADDRNOTAVAIL)
     return ERR_ADDRESS_IN_USE;
 #endif
@@ -1638,7 +1651,7 @@ int UDPSocketPosix::SetSourceGroupMembership(const IPA
