--- third_party/libaom/source/config/linux/x64/config/aom_dsp_rtcd.h.orig	2026-08-24 20:59:34 UTC
+++ third_party/libaom/source/config/linux/x64/config/aom_dsp_rtcd.h
@@ -59,8 +59,6 @@ RTCD_EXTERN void (*aom_blend_a64_vmask)(uint8_t *dst, 
...
@@ -445,8 +443,6 @@ RTCD_EXTERN void (*aom_hadamard_lp_8x8_dual)(const int
