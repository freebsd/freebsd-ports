--- chrome/browser/web_applications/os_integration/web_app_shortcut.cc.orig	2026-06-23 23:37:18 UTC
+++ chrome/browser/web_applications/os_integration/web_app_shortcut.cc
@@ -66,7 +66,7 @@ const int kDesiredIconSizesForShortcut[] = {16, 32, 12
