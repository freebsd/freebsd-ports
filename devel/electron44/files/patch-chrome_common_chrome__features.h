--- chrome/common/chrome_features.h.orig	2026-08-24 20:59:34 UTC
...
@@ -156,7 +156,7 @@ bool RemoteActorCredentialSharingEnabled();
...
@@ -973,7 +973,7 @@ BASE_DECLARE_FEATURE(kIsolatedWebAppBundleCache);
