--- chrome/browser/ui/webui/management/management_ui_constants.cc.orig	2026-04-28 21:06:17 UTC
+++ chrome/browser/ui/webui/management/management_ui_constants.cc
@@ -93,13 +93,13 @@ const char kProfileReportingLearnMore[] = "profileRepo
