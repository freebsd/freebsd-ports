--- chrome/browser/supervised_user/supervised_user_navigation_observer.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -74,7 +74,7 @@ std::unique_ptr<supervised_user::WebContentHandler> Cr
