--- chrome/browser/background/glic/glic_status_icon.cc.orig	2026-06-23 23:37:18 UTC
+++ chrome/browser/background/glic/glic_status_icon.cc
@@ -104,7 +104,7 @@ GlicStatusIcon::~GlicStatusIcon() {
...
@@ -225,7 +225,7 @@ void GlicStatusIcon::UpdateVisibilityOfExitInContextMe
 }
