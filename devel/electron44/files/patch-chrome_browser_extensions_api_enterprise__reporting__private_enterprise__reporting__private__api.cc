--- chrome/browser/extensions/api/enterprise_reporting_private/enterprise_reporting_private_api.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -324,7 +324,7 @@ bool AllowClientCertificateReportingForUsers() {
 }
