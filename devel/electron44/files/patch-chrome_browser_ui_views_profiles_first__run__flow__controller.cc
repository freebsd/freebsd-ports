--- chrome/browser/ui/views/profiles/first_run_flow_controller.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -1198,7 +1198,7 @@ void FirstRunFlowController::MaybeTriggerHatsSurvey() 
 }
