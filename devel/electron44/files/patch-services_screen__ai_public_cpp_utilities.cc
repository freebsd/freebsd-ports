--- services/screen_ai/public/cpp/utilities.cc.orig	2026-08-24 20:59:34 UTC
+++ services/screen_ai/public/cpp/utilities.cc
@@ -26,7 +26,7 @@ constexpr uint32_t kMaxImageDimensionForOcr = 2048;
...
@@ -170,7 +170,7 @@ const char* GetBinaryPathSwitch() {
