--- components/supervised_user/core/browser/supervised_user_utils.cc.orig	2026-06-23 23:37:18 UTC
+++ components/supervised_user/core/browser/supervised_user_utils.cc
@@ -42,7 +42,7 @@ constexpr char kPacpOriginUrlHost[] = "families.google
