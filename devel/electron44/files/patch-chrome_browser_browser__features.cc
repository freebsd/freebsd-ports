--- chrome/browser/browser_features.cc.orig	2026-08-24 20:59:34 UTC
+++ chrome/browser/browser_features.cc
@@ -62,7 +62,7 @@ BASE_FEATURE(kClearUserDataUponProfileDestruction,
...
@@ -72,7 +72,7 @@ BASE_FEATURE(kDestroyProfileOnBrowserClose,
...
@@ -157,7 +157,7 @@ BASE_FEATURE(kSandboxExternalProtocolBlockedWarning,
