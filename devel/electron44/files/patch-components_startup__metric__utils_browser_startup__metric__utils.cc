--- components/startup_metric_utils/browser/startup_metric_utils.cc.orig	2026-08-24 20:59:34 UTC
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 BrowserStartupMetricRecorder::GetHardFaultCountForCurrentProcess() {
   struct rusage usage;
@@ -594,7 +594,7 @@ void BrowserStartupMetricRecorder::RecordHardFaultHist
 }
