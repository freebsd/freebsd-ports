--- components/feature_engagement/public/feature_configurations.cc.orig	2026-08-24 20:59:34 UTC
+++ components/feature_engagement/public/feature_configurations.cc
@@ -102,7 +102,7 @@ std::optional<FeatureConfig> GetClientSideFeatureConfi
