--- content/browser/service_host/utility_process_host.cc.orig	2026-09-01 23:50:56 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 base::ScopedFD PassNetworkContextParentDirs(
   ...
   base::Pickle pickle;
@@ -582,7 +582,7 @@ bool UtilityProcessHost::StartProcess() {
...
@@ -600,7 +600,7 @@ bool UtilityProcessHost::StartProcess() {
