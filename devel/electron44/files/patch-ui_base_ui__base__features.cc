--- ui/base/ui_base_features.cc.orig	2026-08-24 20:59:34 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kGlobalShortcutsPortalPreferredTrigger,
              base::FEATURE_DISABLED_BY_DEFAULT);
 #endif
@@ -200,7 +200,7 @@ BASE_FEATURE(kExperimentalFlingAnimation,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -274,7 +274,7 @@ BASE_FEATURE(kTouchDragAndDrop,
