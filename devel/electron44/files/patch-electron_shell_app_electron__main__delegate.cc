--- electron/shell/app/electron_main_delegate.cc.orig	2026-08-31 00:54:19 UTC
...
@@ -222,7 +222,7 @@ std::optional<int> ElectronMainDelegate::BasicStartupC
     base::win::PinUser32();
 #endif
...
@@ -272,7 +272,7 @@ void ElectronMainDelegate::PreSandboxStartup() {
...
@@ -307,7 +307,7 @@ void ElectronMainDelegate::PreSandboxStartup() {
   }
 #endif
...
+#if !IS_MAS_BUILD() && !BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -326,7 +326,7 @@ void ElectronMainDelegate::PreSandboxStartup() {
...
@@ -356,7 +356,7 @@ std::optional<int> ElectronMainDelegate::PreBrowserMai
...
@@ -364,7 +364,7 @@ std::optional<int> ElectronMainDelegate::PreBrowserMai
 #if BUILDFLAG(IS_MAC)
   RegisterAtomCrApp();
 #endif
-#if BUILDFLAG(IS_LINUX)
