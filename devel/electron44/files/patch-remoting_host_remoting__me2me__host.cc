--- remoting/host/remoting_me2me_host.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -206,7 +206,7 @@ constexpr base::FilePath::CharType kStdinConfigPath[] 
 // from stdin.
...
@@ -868,7 +868,7 @@ void HostProcess::ShutdownOnNetworkThread() {
