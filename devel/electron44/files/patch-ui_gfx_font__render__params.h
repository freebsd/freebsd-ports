--- ui/gfx/font_render_params.h.orig	2026-08-24 20:59:34 UTC
+++ ui/gfx/font_render_params.h
@@ -115,12 +115,12 @@ FontRenderParams GetFontRenderParams(const FontRenderP
...
@@ -130,7 +130,7 @@ COMPONENT_EXPORT(GFX) float GetFontRenderParamsDeviceS
