--- content/browser/service_host/utility_sandbox_delegate.cc.orig	2026-09-01 23:50:56 UTC
...
@@ -77,10 +77,10 @@ UtilitySandboxedProcessLauncherDelegate::
...
@@ -95,11 +95,11 @@ UtilitySandboxedProcessLauncherDelegate::
...
@@ -173,15 +173,15 @@ ZygoteCommunication* UtilitySandboxedProcessLauncherDe
       sandbox_type_ == sandbox::mojom::Sandbox::kNearby ||
 #endif  // BUILDFLAG(IS_CHROMEOS)
       sandbox_type_ == sandbox::mojom::Sandbox::kAudio ||
