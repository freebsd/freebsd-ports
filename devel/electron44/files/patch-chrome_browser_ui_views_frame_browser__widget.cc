--- chrome/browser/ui/views/frame/browser_widget.cc.orig	2026-08-24 20:59:34 UTC
...
@@ -86,7 +86,7 @@ bool IsUsingLinuxSystemTheme(Profile* profile) {
 };
...
@@ -493,7 +493,7 @@ void BrowserWidget::SelectNativeTheme() {
 }
...
@@ -534,7 +534,7 @@ bool BrowserWidget::RegenerateFrameOnThemeChange(
