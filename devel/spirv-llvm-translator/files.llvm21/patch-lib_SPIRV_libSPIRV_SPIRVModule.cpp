--- lib/SPIRV/libSPIRV/SPIRVModule.cpp.orig	2026-09-02 08:55:06 UTC
+++ lib/SPIRV/libSPIRV/SPIRVModule.cpp
@@ -2583,7 +2583,8 @@ std::istream &SPIRVModuleImpl::parseSPIRV(std::istream
...
@@ -2620,8 +2621,7 @@ std::istream &SPIRVModuleImpl::parseSPIRV(std::istream
...
@@ -2744,8 +2744,8 @@ bool isSpirvBinary(const std::string &Img) {
