--- lib/SPIRV/libSPIRV/SPIRVModule.cpp.orig	2026-09-02 08:42:18 UTC
+++ lib/SPIRV/libSPIRV/SPIRVModule.cpp
@@ -2544,7 +2544,8 @@ std::istream &SPIRVModuleImpl::parseSPIRV(std::istream
...
@@ -2581,8 +2582,7 @@ std::istream &SPIRVModuleImpl::parseSPIRV(std::istream
...
@@ -2705,8 +2705,8 @@ bool isSpirvBinary(const std::string &Img) {
