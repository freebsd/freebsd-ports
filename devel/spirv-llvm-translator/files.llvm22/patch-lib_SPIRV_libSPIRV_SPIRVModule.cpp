--- lib/SPIRV/libSPIRV/SPIRVModule.cpp.orig	2026-09-02 08:55:58 UTC
+++ lib/SPIRV/libSPIRV/SPIRVModule.cpp
@@ -2623,7 +2623,8 @@ std::istream &SPIRVModuleImpl::parseSPIRV(std::istream
...
@@ -2660,8 +2661,7 @@ std::istream &SPIRVModuleImpl::parseSPIRV(std::istream
...
@@ -2784,8 +2784,8 @@ bool isSpirvBinary(const std::string &Img) {
