--- electron/spec/api-browser-window-spec.ts.orig	2023-06-12 21:36:35 UTC
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Minimized state', () => {
         it('checks normal bounds when minimized', async () => {
           const bounds = w.getBounds();
           const minimize = emittedOnce(w, 'minimize');
@@ -2350,7 +2350,7 @@ describe('BrowserWindow module', () => {
...
@@ -2376,7 +2376,7 @@ describe('BrowserWindow module', () => {
       });
     });
...
+    ifdescribe(process.platform === 'linux' || process.platform === 'freebsd')(('Linux'), () => {
       it('sets 1 regardless of parameter', () => {
         ...
         w.setOpacity(0);
@@ -3304,7 +3304,7 @@ describe('BrowserWindow module', () => {
...
+    ifit((process.platform === 'linux' || process.platform === 'freebsd') && !process.env.CI)('should bring a minimized maximized window back to maximized state', async () => {
       ...
       const maximize = emittedOnce(w, 'maximize');
       w.maximize();
@@ -4087,7 +4087,7 @@ describe('BrowserWindow module', () => {
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('BrowserWindow.maximize()', () => {
     ...
     it('should show the window if it is not currently shown', async () => {
       const w = new BrowserWindow({ show: false });
@@ -4124,7 +4124,7 @@ describe('BrowserWindow module', () => {
...
@@ -4634,7 +4634,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
@@ -5740,7 +5740,7 @@ describe('BrowserWindow module', () => {
