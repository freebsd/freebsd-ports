--- content/browser/utility_process_host.cc.orig	2024-06-30 11:48:30 UTC
...
@@ -369,6 +369,9 @@ bool UtilityProcessHost::StartProcess() {
...
@@ -429,7 +432,7 @@ bool UtilityProcessHost::StartProcess() {
...
@@ -440,13 +443,13 @@ bool UtilityProcessHost::StartProcess() {
     }
