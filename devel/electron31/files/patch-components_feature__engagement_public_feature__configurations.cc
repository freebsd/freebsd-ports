--- components/feature_engagement/public/feature_configurations.cc.orig	2024-06-18 21:43:28 UTC
+++ components/feature_engagement/public/feature_configurations.cc
@@ -94,7 +94,7 @@ std::optional<FeatureConfig> GetClientSideFeatureConfi
