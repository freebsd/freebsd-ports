--- chrome/common/chrome_features.cc.orig	2026-04-28 21:06:17 UTC
...
@@ -178,7 +178,7 @@ BASE_FEATURE(kShowResetProfileBannerV2, base::FEATURE_
...
@@ -732,7 +732,7 @@ BASE_FEATURE(kGlicGuestContentsVisibilityState,
...
@@ -1200,7 +1200,7 @@ BASE_FEATURE(kIsolatedWebAppBundleCache, base::FEATURE
