--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2026-04-28 21:06:17 UTC
...
@@ -552,7 +552,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -560,11 +560,11 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -595,7 +595,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -1858,7 +1858,7 @@ void AddSignOutDialogStrings(content::WebUIDataSource*
