--- content/utility/on_device_model/on_device_model_sandbox_init.cc.orig	2026-03-13 16:54:03 UTC
...
@@ -82,7 +86,7 @@ bool ShouldWarmDrivers() {
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 void AddSandboxLinuxOptions(sandbox::policy::SandboxLinux::Options& options) {
   ...
   gpu::GPUInfo info;
@@ -166,6 +170,7 @@ bool PreSandboxHook(sandbox::policy::SandboxLinux::Opt
 }
