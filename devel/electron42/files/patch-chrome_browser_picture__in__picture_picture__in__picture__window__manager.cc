--- chrome/browser/picture_in_picture/picture_in_picture_window_manager.cc.orig	2026-03-21 03:23:28 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -591,7 +591,7 @@ bool PictureInPictureWindowManager::IsSupportedForDocu
