--- components/embedder_support/user_agent_utils.cc.orig	2026-03-13 16:54:03 UTC
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   return "Linux; ";
@@ -299,7 +299,7 @@ std::string GetUnifiedPlatform() {
 }
...
@@ -579,7 +579,7 @@ std::string GetPlatformVersion() {
 }
