--- media/mojo/mojom/video_frame_mojom_traits.cc.orig	2026-09-04 04:59:49 UTC
...
@@ -385,7 +385,7 @@ bool StructTraits<media::mojom::VideoFrameDataView,
...
@@ -431,7 +431,7 @@ bool StructTraits<media::mojom::VideoFrameDataView,
