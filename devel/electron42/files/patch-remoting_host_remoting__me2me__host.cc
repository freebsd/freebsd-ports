--- remoting/host/remoting_me2me_host.cc.orig	2026-04-28 21:06:17 UTC
...
@@ -200,7 +200,7 @@ constexpr base::FilePath::CharType kStdinConfigPath[] 
 // from stdin.
...
@@ -853,7 +853,7 @@ void HostProcess::ShutdownOnNetworkThread() {
