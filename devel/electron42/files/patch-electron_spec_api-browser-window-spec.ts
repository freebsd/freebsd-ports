--- electron/spec/api-browser-window-spec.ts.orig	2026-09-08 07:41:45 UTC
...
@@ -395,7 +395,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not be visible when the window is minimized', async () => {
         ...
         w.minimize();
         await minimize;
@@ -1401,7 +1401,7 @@ describe('BrowserWindow module', () => {
       });
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore maximized windows', async () => {
         ...
         w.maximize();
@@ -1466,7 +1466,7 @@ describe('BrowserWindow module', () => {
...
@@ -1571,7 +1571,7 @@ describe('BrowserWindow module', () => {
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('transfers focus status to the next window', async () => {
         ...
         const w2 = new BrowserWindow({ show: false });
         const w3 = new BrowserWindow({ show: false });
@@ -2121,7 +2121,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Maximized state', () => {
         it('checks normal bounds when maximized', async () => {
           ...
           const maximize = once(w, 'maximize');
@@ -2339,7 +2339,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
@@ -3473,7 +3473,7 @@ describe('BrowserWindow module', () => {
       });
     });
...
+    ifdescribe(process.platform === 'linux' || process.platform === 'freebsd')('Linux', () => {
       it('sets 1 regardless of parameter', () => {
         const w = new BrowserWindow({ show: false });
         w.setOpacity(0);
@@ -3713,7 +3713,7 @@ describe('BrowserWindow module', () => {
...
+      if ((process.platform !== 'linux' && process.platform !== 'freebsd') && !w.isMaximized()) {
         ...
         w.show();
         w.maximize();
@@ -3780,7 +3780,7 @@ describe('BrowserWindow module', () => {
...
+        if ((process.platform !== 'linux' && process.platform !== 'freebsd') && !w.isMaximized()) {
           ...
           w.show();
           w.maximize();
@@ -4855,7 +4855,7 @@ describe('BrowserWindow module', () => {
...
@@ -5371,7 +5371,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -5647,7 +5647,7 @@ describe('BrowserWindow module', () => {
     // TODO(zcbenz):
...
@@ -5665,7 +5665,7 @@ describe('BrowserWindow module', () => {
       }
     );
...
@@ -5688,7 +5688,7 @@ describe('BrowserWindow module', () => {
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('BrowserWindow.maximize()', () => {
     ...
     it('should show the window if it is not currently shown', async () => {
       const w = new BrowserWindow({ show: false });
@@ -5725,7 +5725,7 @@ describe('BrowserWindow module', () => {
...
+    ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore a minimized window', async () => {
       ...
       const minimize = once(w, 'minimize');
       w.minimize();
@@ -6223,7 +6223,7 @@ describe('BrowserWindow module', () => {
       });
...
@@ -6464,7 +6464,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
@@ -7782,7 +7782,7 @@ describe('BrowserWindow module', () => {
