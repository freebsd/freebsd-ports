--- chrome/browser/enterprise/browser_management/browser_management_service.cc.orig	2026-04-28 21:06:17 UTC
...
@@ -75,7 +75,7 @@ ui::ImageModel* BrowserManagementService::GetManagemen
 }
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
@@ -84,7 +84,7 @@ gfx::Image* BrowserManagementService::GetManagementIco
 }
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 void BrowserManagementService::SetBrowserManagementIconForTesting(
   ...
   CHECK_IS_TEST();
@@ -186,7 +186,7 @@ void BrowserManagementService::OnPolicyStatusChanged()
