--- electron/spec/api-utility-process-spec.ts.orig	2026-05-26 16:24:13 UTC
+++ electron/spec/api-utility-process-spec.ts
@@ -567,7 +567,7 @@ describe('utilityProcess module', () => {
...
@@ -604,7 +604,7 @@ describe('utilityProcess module', () => {
       await closeWindow(w);
     });
