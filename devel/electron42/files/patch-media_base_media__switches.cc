...
@@ -713,7 +735,7 @@ BASE_FEATURE(kMediaRemotingWithoutFullscreen,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -736,7 +758,7 @@ BASE_FEATURE(kUnifiedAutoplay, base::FEATURE_ENABLED_B
 // autoplay policy.
...
@@ -792,7 +814,7 @@ BASE_FEATURE(kVSyncMjpegDecoding, base::FEATURE_DISABL
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 BASE_FEATURE(kV4L2H264TemporalLayerHWEncoding,
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -976,7 +998,7 @@ BASE_FEATURE(kHardwareMediaKeyHandling,
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
              ...
              base::FEATURE_ENABLED_BY_DEFAULT
 #else
@@ -1334,7 +1356,7 @@ BASE_FEATURE(kUseSharedImageInOOPVDProcess, base::FEAT
...
@@ -1396,7 +1418,7 @@ BASE_FEATURE(kRecordWebAudioEngagement, base::FEATURE_
