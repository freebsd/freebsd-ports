--- electron/shell/common/api/electron_api_shared_texture.cc.orig	2026-05-08 13:54:01 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -548,7 +548,7 @@ struct ImportSharedTextureInfo {
...
@@ -618,7 +618,7 @@ struct Converter<ImportSharedTextureInfo> {
...
@@ -694,7 +694,7 @@ v8::Local<v8::Value> ImportSharedTexture(v8::Isolate* 
