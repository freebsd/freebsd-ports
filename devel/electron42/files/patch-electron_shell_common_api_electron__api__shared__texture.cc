--- electron/shell/common/api/electron_api_shared_texture.cc.orig	2026-08-24 01:09:19 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -584,7 +584,7 @@ struct ImportSharedTextureInfo {
...
@@ -654,7 +654,7 @@ struct Converter<ImportSharedTextureInfo> {
...
@@ -730,7 +730,7 @@ v8::Local<v8::Value> ImportSharedTexture(v8::Isolate* 
