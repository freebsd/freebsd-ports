--- chrome/browser/ui/webui/settings/site_settings_handler.cc.orig	2026-04-28 21:06:17 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (web_app_provider) {
@@ -2190,7 +2190,7 @@ void SiteSettingsHandler::HandleRemoveZoomLevel(const 
