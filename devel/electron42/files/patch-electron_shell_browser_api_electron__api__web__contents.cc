--- electron/shell/browser/api/electron_api_web_contents.cc.orig	2026-06-09 06:05:33 UTC
...
@@ -2982,13 +2982,13 @@ void WebContents::ForcefullyCrashRenderer() {
...
@@ -3698,7 +3698,7 @@ void WebContents::Focus() {
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -4599,7 +4599,7 @@ ui::ImageModel WebContents::GetDevToolsWindowIcon() {
 }
 #endif
