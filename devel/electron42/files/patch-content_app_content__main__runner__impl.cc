--- content/app/content_main_runner_impl.cc.orig	2026-05-12 08:53:52 UTC
...
+
 ...
 #include "base/system/sys_info.h"
@@ -371,7 +378,7 @@ void InitializeZygoteSandboxForBrowserProcess(
 }
...
@@ -390,7 +397,10 @@ void PreSandboxInit() {
...
+#endif
   ...
   // files.
@@ -402,9 +412,16 @@ void PreSandboxInit() {
...
@@ -633,7 +650,7 @@ NO_STACK_PROTECTOR int RunZygote(ContentMainDelegate* 
...
@@ -858,11 +875,10 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1020,7 +1036,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
     // SeatbeltExecServer.
...
@@ -1034,6 +1050,16 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1150,6 +1176,11 @@ NO_STACK_PROTECTOR int ContentMainRunnerImpl::Run() {
