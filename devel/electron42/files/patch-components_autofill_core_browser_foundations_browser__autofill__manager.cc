--- components/autofill/core/browser/foundations/browser_autofill_manager.cc.orig	2026-04-28 21:06:17 UTC
+++ components/autofill/core/browser/foundations/browser_autofill_manager.cc
@@ -938,7 +938,7 @@ payments::BnplManager* BrowserAutofillManager::GetPaym
