--- chrome/browser/enterprise/util/managed_browser_utils.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -410,7 +410,7 @@ bool CanShowEnterpriseBadgingForNTPFooter(Profile* pro
 }
...
@@ -428,7 +428,7 @@ BrowserManagementNoticeState GetManagementNoticeStateF
