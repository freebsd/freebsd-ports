--- components/autofill/core/common/autofill_payments_features.cc.orig	2026-06-02 17:55:02 UTC
...
@@ -43,7 +43,7 @@ BASE_FEATURE(kAutofillEnableAmountExtraction,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -77,7 +77,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLaterForExternall
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -96,7 +96,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLaterSyncing,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -106,7 +106,7 @@ BASE_FEATURE(kAutofillEnableBuyNowPayLaterUpdatedSugge
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -126,7 +126,7 @@ BASE_FEATURE(kAutofillEnableCardBenefitsForBmo,
 // UI.
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -170,7 +170,7 @@ BASE_FEATURE(kAutofillEnableFlatRateCardBenefitsFromCu
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -252,7 +252,7 @@ BASE_FEATURE(kAutofillEnableVcn3dsAuthentication,
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -331,7 +331,7 @@ bool ShouldShowImprovedUserConsentForCreditCardSave() 
     /*default_value=*/180};
