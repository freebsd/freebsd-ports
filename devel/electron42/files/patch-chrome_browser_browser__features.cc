--- chrome/browser/browser_features.cc.orig	2026-04-28 21:06:17 UTC
+++ chrome/browser/browser_features.cc
@@ -66,7 +66,7 @@ BASE_FEATURE(kClearUserDataUponProfileDestruction,
...
@@ -175,7 +175,7 @@ BASE_FEATURE(kSandboxExternalProtocolBlockedWarning,
