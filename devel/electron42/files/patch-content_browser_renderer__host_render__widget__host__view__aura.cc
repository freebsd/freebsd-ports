--- content/browser/renderer_host/render_widget_host_view_aura.cc.orig	2026-06-02 11:14:29 UTC
...
@@ -3046,7 +3046,7 @@ bool RenderWidgetHostViewAura::NeedsMouseCapture() {
 }
