--- content/browser/service_host/utility_sandbox_delegate.cc.orig	2026-01-18 20:29:18 UTC
...
@@ -74,10 +74,10 @@ UtilitySandboxedProcessLauncherDelegate::
...
@@ -92,11 +92,11 @@ UtilitySandboxedProcessLauncherDelegate::
...
@@ -170,15 +170,15 @@ ZygoteCommunication* UtilitySandboxedProcessLauncherDe
       sandbox_type_ == sandbox::mojom::Sandbox::kNearby ||
 #endif  // BUILDFLAG(IS_CHROMEOS)
       sandbox_type_ == sandbox::mojom::Sandbox::kAudio ||
