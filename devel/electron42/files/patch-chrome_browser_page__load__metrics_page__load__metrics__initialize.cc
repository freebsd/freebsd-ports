--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-04-28 21:06:17 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -361,7 +361,7 @@ bool PageLoadMetricsEmbedder::ShouldObserveScheme(std:
