--- chrome/browser/download/download_prefs.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -468,7 +473,7 @@ void DownloadPrefs::DisableAutoOpenByUserBasedOnExtens
 }
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 void DownloadPrefs::SetShouldOpenPdfInSystemReader(bool should_open) {
   if (should_open_pdf_in_system_reader_ == should_open)
     return;
@@ -494,7 +499,7 @@ void DownloadPrefs::ResetAutoOpenByUser() {
...
@@ -531,7 +536,7 @@ bool DownloadPrefs::CanPlatformEnableAutoOpenForPdf() 
...
+#elif BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #else
   return false;
@@ -683,7 +688,14 @@ base::FilePath DownloadPrefs::SanitizeDownloadTargetPa
 #else
