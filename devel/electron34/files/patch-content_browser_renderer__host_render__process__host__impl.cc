--- content/browser/renderer_host/render_process_host_impl.cc.orig	2025-02-02 01:39:08 UTC
...
@@ -1259,7 +1259,7 @@ void RenderProcessHostImpl::IOThreadHostImpl::SetPid(
...
@@ -3265,7 +3265,7 @@ void RenderProcessHostImpl::AppendRendererCommandLine(
