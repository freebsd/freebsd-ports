--- components/commerce/core/commerce_feature_list.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -248,7 +248,7 @@ const char kDiscountOnShoppyPageParam[] = "discount-on
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 BASE_FEATURE(kEnableDiscountInfoApiRegionLaunched,
              ...
              base::FEATURE_ENABLED_BY_DEFAULT);
@@ -296,7 +296,7 @@ BASE_FEATURE(kShoppingList, "ShoppingList", base::FEAT
