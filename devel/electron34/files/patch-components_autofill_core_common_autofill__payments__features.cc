--- components/autofill/core/common/autofill_payments_features.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -319,7 +319,7 @@ bool ShouldShowImprovedUserConsentForCreditCardSave() 
