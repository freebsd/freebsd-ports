--- media/base/media_switches.h.orig	2025-01-27 17:37:37 UTC
...
@@ -345,7 +357,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kUseFakeDeviceForMed
...
@@ -498,7 +510,7 @@ MEDIA_EXPORT BASE_DECLARE_FEATURE(kUseGTFOOutOfProcess
