--- chrome/common/chrome_features.cc.orig	2025-01-27 17:37:37 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 // discard memory.
@@ -240,7 +240,7 @@ BASE_FEATURE(kDesktopPWAsRunOnOsLogin,
...
@@ -332,7 +332,7 @@ BASE_FEATURE(kGeoLanguage, "GeoLanguage", base::FEATUR
 // of languages.
