--- chrome/browser/web_applications/test/os_integration_test_override_impl.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -312,7 +312,7 @@ bool OsIntegrationTestOverrideImpl::DeleteApplicationM
 }
...
@@ -326,7 +326,7 @@ bool OsIntegrationTestOverrideImpl::IsRunOnOsLoginEnab
     Profile* profile,
     const webapps::AppId& app_id,
...
@@ -381,7 +381,7 @@ bool OsIntegrationTestOverrideImpl::IsFileExtensionHan
   is_file_handled =
...
@@ -424,7 +424,7 @@ OsIntegrationTestOverrideImpl::GetShortcutIconTopLeftC
     return std::nullopt;
   }
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!provider) {
     return std::nullopt;
@@ -473,7 +473,7 @@ base::FilePath OsIntegrationTestOverrideImpl::GetShort
