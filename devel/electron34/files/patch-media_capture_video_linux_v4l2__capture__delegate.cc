--- media/capture/video/linux/v4l2_capture_delegate.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -795,7 +807,7 @@ V4L2CaptureDelegate::~V4L2CaptureDelegate() = default;
...
@@ -816,6 +828,7 @@ void V4L2CaptureDelegate::ReplaceControlEventSubscript
 }
