--- ui/base/ime/init/input_method_initializer.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -31,7 +31,7 @@ void InitializeInputMethodForTesting() {
 }
...
@@ -43,7 +43,7 @@ void ShutdownInputMethodForTesting() {
 }
