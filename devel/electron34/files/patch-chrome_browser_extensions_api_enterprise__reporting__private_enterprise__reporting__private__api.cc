--- chrome/browser/extensions/api/enterprise_reporting_private/enterprise_reporting_private_api.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -159,7 +159,7 @@ bool AllowClientCertificateReportingForUsers() {
 }
