--- chrome/browser/chrome_content_browser_client.cc.orig	2025-01-27 17:37:37 UTC
...
@@ -2729,7 +2729,9 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   MaybeAddThrottle(browser_switcher::BrowserSwitcherNavigationThrottle::
                        MaybeCreateThrottleFor(handle),
                    &throttles);
@@ -7548,7 +7550,7 @@ bool ChromeContentBrowserClient::ShouldRunOutOfProcess
