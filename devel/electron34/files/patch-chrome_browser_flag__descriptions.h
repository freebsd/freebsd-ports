--- chrome/browser/flag_descriptions.h.orig	2025-01-27 17:37:37 UTC
+++ chrome/browser/flag_descriptions.h
@@ -291,13 +291,13 @@ extern const char kAutofillDisableLocalCardMigrationDe
...
@@ -556,7 +556,7 @@ extern const char kCommerceHintAndroidDescription[];
...
@@ -737,7 +737,7 @@ extern const char kDevicePostureDescription[];
...
@@ -1227,7 +1227,7 @@ extern const char kContextualPageActionsShareModelDesc
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2004,7 +2004,7 @@ extern const char kSiteInstanceGroupsForDataUrlsDescri
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2163,7 +2163,7 @@ extern const char kTranslateForceTriggerOnEnglishDescr
...
@@ -4429,7 +4429,7 @@ extern const char kBlinkExtensionDiagnosticsDescriptio
...
@@ -4586,6 +4586,9 @@ extern const char kWaylandUiScalingDescription[];
...
@@ -4605,7 +4608,7 @@ extern const char kWebBluetoothConfirmPairingSupportDe
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
@@ -4641,7 +4644,7 @@ extern const char kTaskManagerDesktopRefreshDescriptio
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -4780,7 +4783,7 @@ extern const char kComposeUpfrontInputModesDescription
...
@@ -4850,7 +4853,7 @@ extern const char kOverlayScrollbarsOSSettingsDescript
