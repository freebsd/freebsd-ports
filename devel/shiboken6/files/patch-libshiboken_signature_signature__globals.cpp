--- libshiboken/signature/signature_globals.cpp.orig	2026-08-14 07:58:27 UTC
+++ libshiboken/signature/signature_globals.cpp
@@ -213,7 +213,7 @@ static int init_phase_2(safe_globals_struc *p, PyMetho
 ////////////////////////////////////////////////////////////////////////////
...
+#if defined(__GLIBC__) || defined(__FreeBSD__)
 ...
 #endif
 #include <signal.h>
@@ -221,7 +221,7 @@ static void handler(int sig) {
 #include <unistd.h>
