--- media/capture/video/linux/v4l2_capture_delegate.cc.orig	2023-11-29 21:40:05 UTC
...
+
 ...
 namespace {
@@ -260,7 +272,7 @@ bool V4L2CaptureDelegate::IsControllableControl(
 // static
...
@@ -793,7 +805,7 @@ V4L2CaptureDelegate::~V4L2CaptureDelegate() = default;
...
@@ -814,6 +826,7 @@ void V4L2CaptureDelegate::ReplaceControlEventSubscript
 }
