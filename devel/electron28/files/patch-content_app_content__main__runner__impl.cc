--- content/app/content_main_runner_impl.cc.orig	2023-12-20 07:12:20 UTC
...
@@ -414,7 +418,10 @@ void PreSandboxInit() {
...
+#endif
   ...
   // files.
@@ -426,9 +433,16 @@ void PreSandboxInit() {
...
@@ -835,11 +849,10 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
