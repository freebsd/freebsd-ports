--- chrome/common/chrome_features.cc.orig	2023-11-29 21:39:54 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 // discard memory.
@@ -304,7 +304,7 @@ BASE_FEATURE(kDesktopPWAsRunOnOsLogin,
...
@@ -366,7 +366,7 @@ BASE_FEATURE(kDnsOverHttps,
...
+    BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -382,7 +382,7 @@ const base::FeatureParam<bool> kDnsOverHttpsShowUiPara
