--- chrome/browser/ui/views/web_apps/web_app_integration_test_driver.cc.orig	2023-11-29 21:39:53 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ASSERT_FALSE(override_registration_->test_override->IsRunOnOsLoginEnabled(
       profile(), app_state->id, app_state->name));
 #endif
@@ -3268,7 +3268,7 @@ void WebAppIntegrationTestDriver::CheckSiteHandlesFile
...
@@ -3284,7 +3284,7 @@ void WebAppIntegrationTestDriver::CheckSiteNotHandlesF
