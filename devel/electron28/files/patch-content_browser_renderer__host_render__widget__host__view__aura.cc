--- content/browser/renderer_host/render_widget_host_view_aura.cc.orig	2023-12-20 07:12:20 UTC
...
@@ -2562,7 +2562,7 @@ bool RenderWidgetHostViewAura::NeedsMouseCapture() {
 }
