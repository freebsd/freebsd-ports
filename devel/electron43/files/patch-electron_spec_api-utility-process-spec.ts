--- electron/spec/api-utility-process-spec.ts.orig	2026-09-15 14:47:30 UTC
+++ electron/spec/api-utility-process-spec.ts
@@ -597,7 +597,7 @@ describe('utilityProcess module', () => {
...
@@ -634,7 +634,7 @@ describe('utilityProcess module', () => {
       await closeWindow(w);
     });
