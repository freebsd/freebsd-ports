--- electron/spec/api-utility-process-spec.ts.orig	2026-09-10 01:17:27 UTC
+++ electron/spec/api-utility-process-spec.ts
@@ -596,7 +596,7 @@ describe('utilityProcess module', () => {
...
@@ -633,7 +633,7 @@ describe('utilityProcess module', () => {
       await closeWindow(w);
     });
