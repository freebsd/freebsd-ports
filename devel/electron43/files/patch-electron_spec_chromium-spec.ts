--- electron/spec/chromium-spec.ts.orig	2026-09-18 15:42:59 UTC
+++ electron/spec/chromium-spec.ts
@@ -606,15 +606,15 @@ describe('command line switches', () => {
...
@@ -4232,12 +4232,12 @@ describe('font fallback', () => {
...
+  ifit(process.platform !== 'linux' && process.platform !== 'freebsd')(
     ...
     async function () {
       const html = `
@@ -4952,7 +4952,7 @@ describe('paste execCommand', () => {
   });
 });
