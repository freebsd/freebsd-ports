--- electron/shell/browser/api/electron_api_web_contents.cc.orig	2026-09-10 01:17:27 UTC
...
@@ -3237,13 +3237,13 @@ void WebContents::ForcefullyCrashRenderer() {
...
@@ -3880,7 +3880,7 @@ void WebContents::Focus() {
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -4792,7 +4792,7 @@ ui::ImageModel WebContents::GetDevToolsWindowIcon() {
 }
 #endif
