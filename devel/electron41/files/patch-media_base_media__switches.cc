--- media/base/media_switches.cc.orig	2026-03-13 16:54:03 UTC
...
@@ -677,7 +699,7 @@ BASE_FEATURE(kGlobalMediaControls,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -691,7 +713,7 @@ BASE_FEATURE(kMediaRemotingWithoutFullscreen,
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -717,7 +739,7 @@ BASE_FEATURE(kUnifiedAutoplay, base::FEATURE_ENABLED_B
 // autoplay policy.
...
@@ -773,7 +795,7 @@ BASE_FEATURE(kVSyncMjpegDecoding, base::FEATURE_DISABL
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 BASE_FEATURE(kV4L2H264TemporalLayerHWEncoding,
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -1298,7 +1320,7 @@ BASE_FEATURE(kUseSharedImageInOOPVDProcess, base::FEAT
...
@@ -1360,7 +1382,7 @@ BASE_FEATURE(kRecordWebAudioEngagement, base::FEATURE_
