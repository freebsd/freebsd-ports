--- ui/events/event.cc.orig	2026-03-13 16:54:03 UTC
+++ ui/events/event.cc
@@ -374,7 +374,7 @@ MouseEvent::MouseEvent(const PlatformEvent& native_eve
...
@@ -630,7 +630,7 @@ std::unique_ptr<Event> MouseWheelEvent::Clone() const 
