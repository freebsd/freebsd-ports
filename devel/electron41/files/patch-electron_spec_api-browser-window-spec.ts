--- electron/spec/api-browser-window-spec.ts.orig	2026-08-24 14:04:27 UTC
...
@@ -1289,7 +1289,7 @@ describe('BrowserWindow module', () => {
...
@@ -1474,7 +1474,7 @@ describe('BrowserWindow module', () => {
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('transfers focus status to the next window', async () => {
         ...
         const w2 = new BrowserWindow({ show: false });
         const w3 = new BrowserWindow({ show: false });
@@ -2007,7 +2007,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Maximized state', () => {
         it('checks normal bounds when maximized', async () => {
           ...
           const maximize = once(w, 'maximize');
@@ -2225,7 +2225,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Minimized state', () => {
         it('checks normal bounds when minimized', async () => {
           const bounds = w.getBounds();
           const minimize = once(w, 'minimize');
@@ -3322,7 +3322,7 @@ describe('BrowserWindow module', () => {
...
@@ -3348,7 +3348,7 @@ describe('BrowserWindow module', () => {
       });
     });
...
+    ifdescribe(process.platform === 'linux' || process.platform === 'freebsd')('Linux', () => {
       it('sets 1 regardless of parameter', () => {
         const w = new BrowserWindow({ show: false });
         w.setOpacity(0);
@@ -3578,7 +3578,7 @@ describe('BrowserWindow module', () => {
...
+      if ((process.platform !== 'linux' && process.platform !== 'freebsd') && !w.isMaximized()) {
         ...
         w.show();
         w.maximize();
@@ -3645,7 +3645,7 @@ describe('BrowserWindow module', () => {
...
+        if ((process.platform !== 'linux' && process.platform !== 'freebsd') && !w.isMaximized()) {
           ...
           w.show();
           w.maximize();
@@ -4347,7 +4347,7 @@ describe('BrowserWindow module', () => {
...
@@ -4863,7 +4863,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -5139,7 +5139,7 @@ describe('BrowserWindow module', () => {
     // TODO(zcbenz):
...
@@ -5157,7 +5157,7 @@ describe('BrowserWindow module', () => {
       }
     );
...
@@ -5180,7 +5180,7 @@ describe('BrowserWindow module', () => {
   });
...
+    ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore a minimized window', async () => {
       ...
       const minimize = once(w, 'minimize');
       w.minimize();
@@ -5715,7 +5715,7 @@ describe('BrowserWindow module', () => {
       });
...
@@ -5983,7 +5983,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
@@ -7302,7 +7302,7 @@ describe('BrowserWindow module', () => {
