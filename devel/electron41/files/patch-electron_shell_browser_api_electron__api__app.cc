--- electron/shell/browser/api/electron_api_app.cc.orig	2026-07-20 10:13:43 UTC
...
@@ -1465,7 +1465,7 @@ std::vector<gin_helper::Dictionary> App::GetAppMetrics
...
@@ -1972,7 +1972,7 @@ gin::ObjectTemplateBuilder App::GetObjectTemplateBuild
