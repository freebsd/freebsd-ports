--- sandbox/policy/sandbox_type.cc.orig	2026-03-13 16:54:03 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -34,7 +34,7 @@ constexpr char kSpeechRecognitionSandbox[] = "speech_r
...
+    BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -55,11 +55,11 @@ constexpr char kProxyResolverSandbox[] = "proxy_resolv
...
@@ -77,7 +77,7 @@ constexpr char kNearbySandbox[] = "nearby";
