--- chrome/browser/chrome_content_browser_client.cc.orig	2026-03-13 16:54:03 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!content::AreIsolatedWebAppsEnabled(browser_context)) {
     return false;
@@ -2702,7 +2702,9 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4099,7 +4101,7 @@ std::optional<SkColor> GetRootScrollbarThemeColor(WebC
...
@@ -7326,7 +7328,7 @@ bool ChromeContentBrowserClient::ShouldRunOutOfProcess
