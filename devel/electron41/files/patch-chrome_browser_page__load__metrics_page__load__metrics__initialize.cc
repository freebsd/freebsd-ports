--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-03-20 23:30:17 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -354,7 +354,7 @@ bool PageLoadMetricsEmbedder::ShouldObserveScheme(std:
