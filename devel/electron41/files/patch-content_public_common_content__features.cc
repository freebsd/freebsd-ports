--- content/public/common/content_features.cc.orig	2026-03-13 16:54:03 UTC
+++ content/public/common/content_features.cc
@@ -119,7 +119,7 @@ BASE_FEATURE(kAudioServiceOutOfProcess,
...
@@ -1138,10 +1138,10 @@ BASE_FEATURE(kWebAssemblyTrapHandler,
