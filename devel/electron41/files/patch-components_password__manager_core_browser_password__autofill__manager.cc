--- components/password_manager/core/browser/password_autofill_manager.cc.orig	2026-03-13 16:54:03 UTC
...
@@ -635,7 +635,7 @@ void PasswordAutofillManager::DidNavigateMainFrame() {
