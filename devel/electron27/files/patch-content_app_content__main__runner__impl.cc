--- content/app/content_main_runner_impl.cc.orig	2023-10-25 09:13:45 UTC
...
@@ -376,7 +380,7 @@ void InitializeZygoteSandboxForBrowserProcess(
 }
...
@@ -414,7 +418,10 @@ void PreloadLibraryCdms() {
...
+#endif
   ...
   // files.
@@ -425,9 +432,16 @@ void PreSandboxInit() {
...
@@ -834,11 +848,10 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
