--- chrome/browser/download/download_prefs.cc.orig	2024-04-15 20:33:46 UTC
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 void DownloadPrefs::SetShouldOpenPdfInSystemReader(bool should_open) {
   if (should_open_pdf_in_system_reader_ == should_open)
     return;
@@ -505,7 +510,7 @@ void DownloadPrefs::ResetAutoOpenByUser() {
...
@@ -545,7 +550,7 @@ bool DownloadPrefs::CanPlatformEnableAutoOpenForPdf() 
