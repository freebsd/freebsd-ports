--- chrome/common/pref_names.h.orig	2024-04-15 20:33:50 UTC
...
@@ -1997,7 +1997,7 @@ inline constexpr char kDownloadDirUpgraded[] = "downlo
...
+    BUILDFLAG(IS_MAC) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -2431,14 +2431,14 @@ inline constexpr char kMediaCdmOriginData[] = "media.c
...
@@ -2516,7 +2516,7 @@ inline constexpr char kBasicAuthOverHttpEnabled[] =
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -3584,7 +3584,7 @@ inline constexpr char kSandboxExternalProtocolBlocked[
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -3941,7 +3941,7 @@ inline constexpr char kNewBaseUrlInheritanceBehaviorAl
