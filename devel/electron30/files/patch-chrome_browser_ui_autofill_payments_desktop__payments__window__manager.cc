--- chrome/browser/ui/autofill/payments/desktop_payments_window_manager.cc.orig	2024-04-15 20:33:49 UTC
+++ chrome/browser/ui/autofill/payments/desktop_payments_window_manager.cc
@@ -25,7 +25,7 @@ DesktopPaymentsWindowManager::DesktopPaymentsWindowMan
