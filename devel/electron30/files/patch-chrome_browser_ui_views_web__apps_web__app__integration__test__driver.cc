--- chrome/browser/ui/views/web_apps/web_app_integration_test_driver.cc.orig	2024-04-15 20:33:49 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
   ASSERT_FALSE(override_registration_->test_override->IsRunOnOsLoginEnabled(
       profile(), app_state->id, app_state->name));
 #endif
@@ -3440,7 +3440,7 @@ void WebAppIntegrationTestDriver::CheckSiteHandlesFile
...
@@ -3456,7 +3456,7 @@ void WebAppIntegrationTestDriver::CheckSiteNotHandlesF
