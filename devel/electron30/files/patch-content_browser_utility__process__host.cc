--- content/browser/utility_process_host.cc.orig	2024-04-28 08:50:04 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_CHROMEOS_ASH) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -236,7 +236,7 @@ void UtilityProcessHost::SetAllowGpuClient() {
...
@@ -454,7 +454,7 @@ bool UtilityProcessHost::StartProcess() {
...
@@ -465,13 +465,13 @@ bool UtilityProcessHost::StartProcess() {
     }
