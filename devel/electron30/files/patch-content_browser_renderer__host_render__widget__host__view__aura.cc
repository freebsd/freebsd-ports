--- content/browser/renderer_host/render_widget_host_view_aura.cc.orig	2024-04-28 08:50:04 UTC
...
@@ -2538,7 +2538,7 @@ bool RenderWidgetHostViewAura::NeedsMouseCapture() {
 }
