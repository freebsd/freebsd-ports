--- programs/dtappbuilder/src/ab/pal_termp.c.orig	2023-02-15 07:52:17.528132000 -0800
+++ programs/dtappbuilder/src/ab/pal_termp.c	2023-02-15 07:54:16.371702000 -0800
@@ -267,9 +267,9 @@
 	/* Scrolling */
         n = 0;
