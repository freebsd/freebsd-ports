--- programs/dtappbuilder/src/ab/pal_textp.c.orig	2023-02-15 07:52:17.537122000 -0800
+++ programs/dtappbuilder/src/ab/pal_textp.c	2023-02-15 07:54:16.373965000 -0800
@@ -270,9 +270,9 @@
 	/* Scrolling */
         n = 0;
