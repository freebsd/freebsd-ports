--- python/samba/provision/__init__.py.orig	2026-01-20 15:42:54 UTC
+++ python/samba/provision/__init__.py
@@ -1676,19 +1676,25 @@ def setsysvolacl(samdb, sysvol, uid, gid, domainsid, d
...
@@ -1911,7 +1917,7 @@ def interface_ips_v6(lp):
     return ret
...
@@ -1970,6 +1976,9 @@ def provision_fill(samdb, secrets_ldb, logger, names,
...
@@ -2346,6 +2355,9 @@ def provision(logger, session_info, smbconf=None,
...
@@ -2355,7 +2367,7 @@ def provision(logger, session_info, smbconf=None,
