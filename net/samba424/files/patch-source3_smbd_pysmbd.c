--- source3/smbd/pysmbd.c.orig	2026-01-20 15:42:54 UTC
+++ source3/smbd/pysmbd.c
@@ -501,6 +501,20 @@ static SMB_ACL_T make_simple_acl(TALLOC_CTX *mem_ctx,
 	return acl;
 }
...
+
  ...
  */
@@ -573,7 +587,85 @@ static PyObject *py_smbd_set_simple_acl(PyObject *self
 	Py_RETURN_NONE;
 }
...
@@ -759,7 +851,7 @@ static PyObject *py_smbd_unlink(PyObject *self, PyObje
 }
...
@@ -771,7 +863,84 @@ static PyObject *py_smbd_have_posix_acls(PyObject *sel
 #endif
 }
...
@@ -1272,8 +1441,26 @@ static PyMethodDef py_smbd_methods[] = {
 	{ "have_posix_acls",
