--- source3/modules/vfs_zfsacl.c.orig	2026-01-20 15:42:54 UTC
+++ source3/modules/vfs_zfsacl.c
@@ -169,6 +169,7 @@ static bool zfs_process_smbacl(vfs_handle_struct *hand
...
@@ -235,24 +236,52 @@ static bool zfs_process_smbacl(vfs_handle_struct *hand
 	SMB_ASSERT(i == naces);
...
@@ -282,25 +311,46 @@ static int fget_zfsacl(TALLOC_CTX *mem_ctx,
...
@@ -309,15 +359,37 @@ static int fget_zfsacl(TALLOC_CTX *mem_ctx,
 		return -1;
 	}
