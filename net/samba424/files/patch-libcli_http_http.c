--- libcli/http/http.c.orig	2026-01-20 15:42:54 UTC
+++ libcli/http/http.c
@@ -177,7 +177,19 @@ static enum http_read_status http_parse_headers(struct
...
@@ -338,7 +350,7 @@ static bool http_parse_response_line(struct http_read_
...
+	char	*protocol = NULL;
 	...
 	char	major;
 	char	minor;
@@ -358,18 +370,32 @@ static bool http_parse_response_line(struct http_read_
 		return false;
 	}
