...
LADSPA_DESC?=		Enable LADSPA audio support
LAME_DESC?=		Enable lame mp3 encoder support
LASH_DESC?=		Enable LASH audio support
...
LIBEDIT_DESC?=		Enable readline support
LIBEXIF_DESC?=		Enable libexif support
...
OPENEXR_DESC?=		Enable HDR support via OpenEXR
OPENGL_DESC?=		Enable OpenGL support
OPENJPEG_DESC?=		Enhanced JPEG graphics support
OPENMP_DESC?=		Enable parallel processing support
