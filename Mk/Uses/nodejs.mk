...
#   - version   available version: lts, current, 20, 22, 24, 26
#
# Note:
...
_VALID_NODEJS_VERSIONS=	20 22 24 26 current lts
...
.  if !empty(nodejs_ARGS:Nbuild:Nenv:Nrun:Nlts:Ncurrent:N20:N22:N24:N26)
