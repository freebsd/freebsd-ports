...
ONLY_FOR_ARCHS_REASON=	Linux compatibility is only available on amd64, i386, and aarch64
.endif
...
MASTER_SITE_SUBDIR=	centos/${LINUX_DIST_VER}/os/x86_64/Packages/:DEFAULT,amd64 \
			...
			altarch/${LINUX_DIST_VER}/os/aarch64/Packages/:DEFAULT,aarch64 \
...
.ifndef DISTFILES
.ifdef DISTFILES_amd64 || DISTFILES_i386 || DISTFILES_aarch64
.if make(makesum)
_ALL_DISTFILES=		${DISTFILES_amd64} ${DISTFILES_i386} ${DISTFILES_aarch64}
