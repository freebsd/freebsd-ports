...
PY_PYGMENTS=	${PYTHON_PKGNAMEPREFIX}pygments-25>=0:textproc/py-pygments-25@${PY_FLAVOR}
...
PY_PYGMENTS=	${PYTHON_PKGNAMEPREFIX}pygments>=0:textproc/py-pygments@${PY_FLAVOR}
