...
.    if ${PYTHON_VER} == 2.7
BUILD_DEPENDS+=		${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools44@${PY_FLAVOR}
RUN_DEPENDS+=		${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools44@${PY_FLAVOR}
.    else
BUILD_DEPENDS+=		${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools@${PY_FLAVOR}
RUN_DEPENDS+=		${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools@${PY_FLAVOR}
.    endif
.  endif
...
PEP517_BUILD_DEPEND?=	${PYTHON_SITELIBDIR}/build/__init__.py:devel/py-build@${PY_FLAVOR}
...
PEP517_INSTALL_DEPEND?=	${PYTHON_SITELIBDIR}/installer/__init__.py:devel/py-installer@${PY_FLAVOR}
...
.  if defined(_PYTHON_FEATURE_DISTUTILS)
.    if ${PYTHON_MAJOR_VER} < 3
PY_SETUPTOOLS=	${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools44@${PY_FLAVOR}
.    else
#PY_SETUPTOOLS=	${PYTHON_SITELIBDIR}/setuptools58:devel/py-setuptools58@${PY_FLAVOR}
PY_SETUPTOOLS=	${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools@${PY_FLAVOR}
.    endif
.  else
PY_SETUPTOOLS=	${PYTHON_SITELIBDIR}/setuptools/__init__.py:devel/py-setuptools@${PY_FLAVOR}
.  endif
