...
# EMACS_CMD:                  Emacs command with full path (e.g. /usr/local/bin/emacs-28.1)
...
# EMACS_LIBDIR_WITH_VER:      Library directory without ${PREFIX} including version (e.g. share/emacs/28.1)
...
# EMACS_VER:                  Emacs version (e.g. 28.1)
# EMACS_VERSION_SITE_LISPDIR: Include version (e.g. share/emacs/28.1/site-lisp)
#-------------------------------------------------------------------------------
#
