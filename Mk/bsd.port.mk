...
.    if defined(CROSS_SYSROOT)
CROSS_ABI_FILE?=${CROSS_SYSROOT}/bin/sh
PKG_ENV+=		ABI_FILE=${CROSS_ABI_FILE}
MAKE_ENV+=		NM=${NM} \
				STRIPBIN=${STRIPBIN} \
