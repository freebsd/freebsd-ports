--- src/redisearch_rs/rqe_iterators/src/utils/timespec.rs.orig	2026-08-15 23:39:28 UTC
+++ src/redisearch_rs/rqe_iterators/src/utils/timespec.rs
@@ -69,7 +69,9 @@ fn monotonic_now_timespec() -> ffi::timespec {
