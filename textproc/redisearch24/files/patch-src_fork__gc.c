--- src/fork_gc.c.orig	2022-02-09 21:38:06 UTC
+++ src/fork_gc.c
@@ -286,6 +286,7 @@ static void sendHeaderString(ForkGC *gc, void *arg) {
 }
...
@@ -302,7 +303,9 @@ static void FGC_childCollectTerms(ForkGC *gc, RedisSea
