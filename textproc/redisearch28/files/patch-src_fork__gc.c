--- src/fork_gc.c.orig	2023-06-07 19:36:39 UTC
+++ src/fork_gc.c
@@ -266,6 +266,7 @@ static void sendHeaderString(ForkGC *gc, void *arg) {
 }
...
@@ -282,7 +283,9 @@ static void FGC_childCollectTerms(ForkGC *gc, RedisSea
